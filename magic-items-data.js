...
const MAGIC_ITEMS_DATA = [
    ...
    // 🛡️ ARMURE
    { nom: "Cotte de mailles en adamantine", type: "Armure", rarete: "Peu commun", lien: false, prix: "5 074 po", note: "Non applicable",
    ...
    { nom: "Cotte de plates en adamantine", type: "Armure", rarete: "Peu commun", lien: false, prix: "5 000 po", note: "Non applicable",
    ...
    { nom: "Cotte de plaques en adamantine", type: "Armure", rarete: "Peu commun", lien: false, prix: "5 033 po", note: "Non applicable",
    ...
    { nom: "Bouclier animé", type: "Armure", rarete: "Très rare", lien: true, prix: "2 700 po", note: "Non applicable",
    ...
    { nom: "Armure étincelante", type: "Armure", rarete: "Commun", lien: false, prix: "330 po", note: "Ajouter le coût de l'armure au total. Basé sur : Prestidigitation.",
    ...
    { nom: "Armure de résistance (plastron)", type: "Armure", rarete: "Rare", lien: true, prix: "9 800 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Armure de résistance (chemise de mailles)", type: "Armure", rarete: "Rare", lien: true, prix: "9 100 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Armure de résistance (cuir)", type: "Armure", rarete: "Rare", lien: true, prix: "9 020 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Armure de résistance (harnois)", type: "Armure", rarete: "Rare", lien: true, prix: "12 000 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Broche de protection", type: "Armure", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : Bouclier (pour l'immunité).",
    ...
    { nom: "Armure à dégrafage rapide", type: "Armure", rarete: "Commun", lien: false, prix: "330 po", note: "Ajouter le coût de l'armure au total. Basé sur : tour de magie.",
    ...
    { nom: "Cape de la chauve-souris", type: "Armure", rarete: "Rare", lien: true, prix: "15 600 po", note: "Basé sur : Amélioration de caractéristique (+1 niv, sans concentration) + Vol (niveau inchangé) + Métamorphose.",
    ...
    { nom: "Cape de la raie manta", type: "Armure", rarete: "Peu commun", lien: false, prix: "9 900 po", note: "Basé sur : Respiration aquatique + Altération personnelle (+1 niveau, sans concentration).",
    ...
    { nom: "Armure démoniaque", type: "Armure", rarete: "Très rare", lien: true, prix: "13 200 po", note: "Non applicable",
    ...
    { nom: "Cotte de plaques draconiques", type: "Armure", rarete: "Très rare", lien: true, prix: "21 900 po", note: "Basé sur : Localisation de créature + Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Harnois nain", type: "Armure", rarete: "Très rare", lien: false, prix: "18 810 po", note: "Non applicable",
    ...
    { nom: "Armure ensorcelée (niv. 1)", type: "Armure", rarete: "Peu commun", lien: true, prix: "1 215 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (niv. 2)", type: "Armure", rarete: "Rare", lien: true, prix: "3 240 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (niv. 3)", type: "Armure", rarete: "Rare", lien: true, prix: "5 400 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (niv. 4)", type: "Armure", rarete: "Très rare", lien: true, prix: "12 150 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (niv. 5)", type: "Armure", rarete: "Très rare", lien: true, prix: "17 010 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (niv. 6)", type: "Armure", rarete: "Légendaire", lien: true, prix: "37 800 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (niv. 7)", type: "Armure", rarete: "Légendaire", lien: true, prix: "48 600 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (niv. 8)", type: "Armure", rarete: "Légendaire", lien: true, prix: "60 750 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure ensorcelée (tour de magie)", type: "Armure", rarete: "Peu commun", lien: true, prix: "405 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure de cuir ensorcelée (tour de magie)", type: "Armure", rarete: "Peu commun", lien: true, prix: "420 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Harnois ensorcelé (niv. 8)", type: "Armure", rarete: "Légendaire", lien: true, prix: "68 250 po", note: "Ajouter le coût de l'armure au prix total.",
    ...
    { nom: "Armure du marin", type: "Armure", rarete: "Peu commun", lien: false, prix: "2 970 po", note: "Basé sur : Altération personnelle.",
    ...
    { nom: "Plastron en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "2 310 po", note: "Non applicable",
    ...
    { nom: "Cotte de mailles en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "1 774 po", note: "Non applicable",
    ...
    { nom: "Chemise de mailles en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "1 733 po", note: "Non applicable",
    ...
    { nom: "Demi-plate en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "2 888 po", note: "Non applicable",
    ...
    { nom: "Harnois en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "4 125 po", note: "Non applicable",
    ...
    { nom: "Cotte de plates en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "1 700 po", note: "Non applicable",
    ...
    { nom: "Cotte de plaques en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "1 733 po", note: "Non applicable",
    ...
    { nom: "Broigne en mithral", type: "Armure", rarete: "Peu commun", lien: false, prix: "1 980 po", note: "Non applicable",
    ...
    { nom: "Harnois d'éthéralité", type: "Armure", rarete: "Légendaire", lien: true, prix: "24 300 po", note: "Basé sur : Éthéralité (niveau réduit en raison de la courte durée).",
    ...
    { nom: "Anneau de protection mentale", type: "Armure", rarete: "Peu commun", lien: true, prix: "12 600 po", note: "Basé sur : Voile mental (-2 niveaux, capacités réduites).",
    ...
    { nom: "Bouclier sentinelle", type: "Armure", rarete: "Peu commun", lien: false, prix: "2 970 po", note: "Basé sur : Amélioration de caractéristique.",
    ...
    { nom: "Bouclier expressif", type: "Armure", rarete: "Commun", lien: false, prix: "341 po", note: "Basé sur : Illusion mineure.",
    ...
    { nom: "Bouclier d'attraction des projectiles", type: "Armure", rarete: "Rare", lien: true, prix: "6 000 po", note: "Basé sur : Protection contre l'énergie.",
    ...
    { nom: "Bouclier du cavalier", type: "Armure", rarete: "Très rare", lien: true, prix: "15 518 po", note: "Basé sur : Sphère résiliente.",
    ...
    { nom: "Armure fumante", type: "Armure", rarete: "Commun", lien: false, prix: "330 po", note: "Ajouter le coût de l'armure au total. Basé sur : Illusion mineure.",
    ...
    { nom: "Bouclier de protection magique", type: "Armure", rarete: "Très rare", lien: true, prix: "25 200 po", note: "Basé sur : Cercle de pouvoir (+1 niveau, sans concentration).",
    ...
    // ⚔️ ARME
    { nom: "Épée de puissance niveau 10", type: "Arme", rarete: "Légendaire", lien: true, prix: "114 050 po", note: "Non applicable",
    ...
    { nom: "Munitions en adamantine", type: "Arme", rarete: "Peu commun", lien: false, prix: "4 950 po", note: "Ajouter le coût des munitions (carquois) au prix total.",
    ...
    { nom: "Flèches en adamantine (20)", type: "Arme", rarete: "Peu commun", lien: false, prix: "4 952 po", note: "Prix pour 1 carquois de 20 flèches.",
    ...
    { nom: "Arme en adamantine", type: "Arme", rarete: "Peu commun", lien: false, prix: "5 445 po", note: "Ajouter le coût de l'arme au total. Tour de magie inclus pour la propriété d'arme magique.",
    ...
    { nom: "Munitions de mise à mort", type: "Arme", rarete: "Très rare", lien: true, prix: "267 po", note: "Non applicable",
    ...
    { nom: "Munitions +2", type: "Arme", rarete: "Rare", lien: false, prix: "990 po", note: "Non applicable",
    ...
    { nom: "Munitions +3", type: "Arme", rarete: "Très rare", lien: false, prix: "2 772 po", note: "Non applicable",
    ...
    { nom: "Flèche de mise à mort", type: "Arme", rarete: "Très rare", lien: true, prix: "267 po", note: "Non applicable",
    ...
    { nom: "Hache des seigneurs nains", type: "Arme", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Hache du berserker", type: "Arme", rarete: "Rare", lien: true, prix: "— po", note: "Maudit(e) — prix non défini.",
    ...
    { nom: "Coupe de commandement des élémentaires d'eau", type: "Arme", rarete: "Rare", lien: false, prix: "7 392 po", note: "Basé sur : Convocation d'élémentaire (+1 niveau, sans concentration).",
    ...
    { nom: "Arc d'énergie", type: "Arme", rarete: "Très rare", lien: true, prix: "12 570 po", note: "Basé sur : Pas brumeux (+2 niveaux, portée augmentée, affecte d'autres) + Marche sur les parois.",
    ...
    { nom: "Glaive ensorcelé (niv. 8)", type: "Arme", rarete: "Légendaire", lien: true, prix: "60 850 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Épée courte ensorcelée (tour de magie)", type: "Arme", rarete: "Peu commun", lien: true, prix: "420 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 1)", type: "Arme", rarete: "Peu commun", lien: true, prix: "1 215 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 2)", type: "Arme", rarete: "Rare", lien: true, prix: "3 240 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 3)", type: "Arme", rarete: "Rare", lien: true, prix: "5 400 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 4)", type: "Arme", rarete: "Très rare", lien: true, prix: "12 150 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 5)", type: "Arme", rarete: "Très rare", lien: true, prix: "17 010 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 6)", type: "Arme", rarete: "Légendaire", lien: true, prix: "37 800 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 7)", type: "Arme", rarete: "Légendaire", lien: true, prix: "48 600 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (niv. 8)", type: "Arme", rarete: "Légendaire", lien: true, prix: "60 750 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Arme ensorcelée (tour de magie)", type: "Arme", rarete: "Peu commun", lien: true, prix: "405 po", note: "Ajouter le coût de l'arme au prix total.",
    ...
    { nom: "Hache du bourreau", type: "Arme", rarete: "Très rare", lien: false, prix: "3 465 po", note: "Non applicable",
    ...
    { nom: "Marteau du tonnerre", type: "Arme", rarete: "Légendaire", lien: false, prix: "72 545 po", note: "Basé sur : Mot de pouvoir étourdissant. +1 260 po pour boost de Force supplémentaire.",
    ...
    { nom: "Javelot de foudre", type: "Arme", rarete: "Peu commun", lien: false, prix: "1 683 po", note: "Basé sur : Éclair (niveau réduit) + tour de magie permanent pour propriété d'arme magique.",
    ...
    { nom: "Lame de chance", type: "Arme", rarete: "Légendaire", lien: true, prix: "37 750 po", note: "Basé sur : Vœu ×3 + Amélioration de caractéristique (+1 niveau, sans concentration).",
    ...
    { nom: "Masse de disruption", type: "Arme", rarete: "Rare", lien: true, prix: "1 880 po", note: "Tour de magie : arme magique + Lumière.",
    ...
    { nom: "Masse de frappe sacrée", type: "Arme", rarete: "Rare", lien: false, prix: "8 140 po", note: "Divers : moitié du coût d'une arme +3 infligeant 14 dégâts.",
    ...
    { nom: "Masse de terreur", type: "Arme", rarete: "Rare", lien: true, prix: "4 200 po", note: "Basé sur : Terreur + tour de magie pour arme magique.",
    ...
    { nom: "Faucille de lune +1", type: "Arme", rarete: "Peu commun", lien: true, prix: "4 815 po", note: "DD du sort = bonus de CA. Soin 1d4 traité comme Mot de guérison illimité. Coût inclut focaliseur + bonus d'attaque de sort.",
    ...
    { nom: "Faucille de lune +2", type: "Arme", rarete: "Rare", lien: true, prix: "15 620 po", note: "DD du sort = bonus de CA. Soin 1d4 traité comme Mot de guérison illimité. Coût inclut focaliseur + bonus d'attaque de sort.",
    ...
    { nom: "Faucille de lune +3", type: "Arme", rarete: "Très rare", lien: true, prix: "44 130 po", note: "DD du sort = bonus de CA. Soin 1d4 traité comme Mot de guérison illimité. Coût inclut focaliseur + bonus d'attaque de sort.",
    ...
    { nom: "Épée touchée par la lune", type: "Arme", rarete: "Commun", lien: false, prix: "660 po", note: "Basé sur : Lumière.",
    ...
    { nom: "Lame de lune", type: "Arme", rarete: "Légendaire", lien: true, prix: "— po", note: "Prix non défini — se comporte comme un artefact qui choisit son porteur.",
    ...
    { nom: "Arc du serment", type: "Arme", rarete: "Très rare", lien: true, prix: "6 471 po", note: "Basé sur : Invisibilité (pour avantage permanent).",
    ...
    { nom: "Jeton-plume de Quaal (fouet)", type: "Arme", rarete: "Rare", lien: false, prix: "660 po", note: "Basé sur : Arme spirituelle (+1 niveau).",
    ...
    { nom: "Bâton de l'acrobate", type: "Arme", rarete: "Très rare", lien: true, prix: "12 420 po", note: "Basé sur : Lumière + Amélioration de caractéristique (-1/+1 niv) + Bouclier (3 charges).",
    ...
    { nom: "Cimeterre de rapidité", type: "Arme", rarete: "Très rare", lien: true, prix: "9 900 po", note: "Basé sur : Hâte (niveau réduit).",
    ...
    { nom: "Épée courte +1", type: "Arme", rarete: "Peu commun", lien: false, prix: "842 po", note: "Non applicable",
    ...
    { nom: "Grande hache argentée", type: "Arme", rarete: "Commun", lien: false, prix: "269 po", note: "Non applicable",
    ...
    { nom: "Épée courte argentée", type: "Arme", rarete: "Commun", lien: false, prix: "129 po", note: "Non applicable",
    ...
    { nom: "Lame de soleil", type: "Arme", rarete: "Rare", lien: true, prix: "3 886 po", note: "Non applicable",
    ...
    { nom: "Épée de riposte", type: "Arme", rarete: "Légendaire", lien: true, prix: "30 000 po", note: "Basé sur : Hâte.",
    ...
    { nom: "Épée de Kas", type: "Arme", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Épée de tranchant", type: "Arme", rarete: "Très rare", lien: true, prix: "2 785 po", note: "Dégâts supplémentaires = max espadon - moyenne.",
    ...
    { nom: "Épée de vengeance", type: "Arme", rarete: "Peu commun", lien: true, prix: "750 po", note: "Maudit(e) — prix non défini.",
    ...
    { nom: "Épée de blessure", type: "Arme", rarete: "Rare", lien: true, prix: "1 715 po", note: "Saignement traité comme poison. Divers : guérison difficile.",
    ...
    { nom: "Grande massue tonnante", type: "Arme", rarete: "Très rare", lien: true, prix: "42 257 po", note: "Basé sur : Tremblement de terre (niveau réduit, durée 1 round).",
    ...
    { nom: "Trident de commandement des poissons", type: "Arme", rarete: "Peu commun", lien: true, prix: "4 050 po", note: "Basé sur : Domination des bêtes.",
    ...
    { nom: "Flèche incassable", type: "Arme", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Réparation.",
    ...
    { nom: "Épée vorpale", type: "Arme", rarete: "Légendaire", lien: true, prix: "51 855 po", note: "Basé sur : Protection contre l'énergie (+2 niveaux, sans concentration, ignore les résistances).",
    ...
    { nom: "Munitions assommantes", type: "Arme", rarete: "Commun", lien: false, prix: "33 po", note: "Non applicable",
    ...
    { nom: "Baguette d'éclairs", type: "Arme", rarete: "Rare", lien: true, prix: "6 000 po", note: "Basé sur : Éclair (×7 charges).",
    ...
    // 💍 ANNEAU
    { nom: "Anneau de commandement des élémentaires d'air", type: "Anneau", rarete: "Légendaire", lien: true, prix: "67 050 po", note: "Basé sur : Protection mal/bien + Domination de monstre + Chute de plume. Divers : Protection contre l'énergie.",
    ...
    { nom: "Anneau d'influence animale", type: "Anneau", rarete: "Rare", lien: false, prix: "4 290 po", note: "Charges selon le niveau de sort maximum. Partage de charges selon la somme des sorts disponibles.",
    ...
    { nom: "Anneau d'invocation du djinn", type: "Anneau", rarete: "Légendaire", lien: true, prix: "33 000 po", note: "Basé sur : Convocation d'élémentaire (niveau 9).",
    ...
    { nom: "Anneau de commandement des élémentaires de terre", type: "Anneau", rarete: "Légendaire", lien: true, prix: "67 650 po", note: "Basé sur : Protection mal/bien + Domination de monstre + Liberté de mouvement (-3 niveaux). Divers : Protection contre l'énergie.",
    ...
    { nom: "Anneau de chute de plume", type: "Anneau", rarete: "Rare", lien: true, prix: "1 800 po", note: "Basé sur : Chute de plume.",
    ...
    { nom: "Anneau de commandement des élémentaires de feu", type: "Anneau", rarete: "Légendaire", lien: true, prix: "104 400 po", note: "Basé sur : Protection mal/bien + Domination de monstre + Investiture (immunité). Divers : résistance protection énergie.",
    ...
    { nom: "Anneau d'invisibilité", type: "Anneau", rarete: "Légendaire", lien: true, prix: "31 500 po", note: "Basé sur : Invisibilité supérieure (+1 niveau, sans concentration).",
    ...
    { nom: "Anneau de saut", type: "Anneau", rarete: "Peu commun", lien: true, prix: "1 350 po", note: "Basé sur : Saut.",
    ...
    { nom: "Anneau de régénération", type: "Anneau", rarete: "Très rare", lien: true, prix: "32 400 po", note: "Basé sur : Régénération.",
    ...
    { nom: "Anneau d'étoiles filantes", type: "Anneau", rarete: "Très rare", lien: true, prix: "5 276 po", note: "Basé sur : Feu de faerie (charges). Additionnels : Lumières dansantes permanentes + Lumière.",
    ...
    { nom: "Anneau de renvoi des sorts", type: "Anneau", rarete: "Légendaire", lien: true, prix: "31 500 po", note: "Basé sur : Cercle de pouvoir.",
    ...
    { nom: "Anneau de natation", type: "Anneau", rarete: "Peu commun", lien: false, prix: "4 950 po", note: "Basé sur : Altération personnelle (+1 niveau, sans concentration).",
    ...
    { nom: "Anneau de télékinésie", type: "Anneau", rarete: "Très rare", lien: true, prix: "18 900 po", note: "Basé sur : Télékinésie (niveau inchangé malgré la restriction, sans concentration).",
    ...
    { nom: "Anneau des trois vœux", type: "Anneau", rarete: "Légendaire", lien: false, prix: "27 225 po", note: "Basé sur : Vœu (×3).",
    ...
    { nom: "Anneau de chaleur", type: "Anneau", rarete: "Peu commun", lien: true, prix: "6 750 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Anneau de commandement des élémentaires d'eau", type: "Anneau", rarete: "Légendaire", lien: true, prix: "72 450 po", note: "Basé sur : Protection mal/bien + Domination de monstre + Marche sur l'eau (-1 niv). Divers : Respiration aquatique (-1 niv).",
    ...
    { nom: "Anneau de marche sur l'eau", type: "Anneau", rarete: "Peu commun", lien: false, prix: "7 425 po", note: "Basé sur : Marche sur l'eau (+1 niveau, sans concentration).",
    ...
    { nom: "Anneau de vision aux rayons X", type: "Anneau", rarete: "Rare", lien: true, prix: "3 600 po", note: "Basé sur : Œil arcanique (-2 niveaux).",
    ...
    { nom: "Anneau du bélier", type: "Anneau", rarete: "Rare", lien: true, prix: "708 po", note: "Non applicable",
    ...
    // 🧪 POTION
    { nom: "Élixir de santé", type: "Potion", rarete: "Rare", lien: false, prix: "396 po", note: "Basé sur : Restauration inférieure.",
    ...
    { nom: "Philtre d'amour", type: "Potion", rarete: "Peu commun", lien: false, prix: "1 040 po", note: "Basé sur : Charme monstre (+1 niveau).",
    ...
    { nom: "Potion d'amitié animale", type: "Potion", rarete: "Peu commun", lien: false, prix: "149 po", note: "Basé sur : Amitié avec les animaux.",
    ...
    { nom: "Potion de clairvoyance", type: "Potion", rarete: "Rare", lien: false, prix: "990 po", note: "Basé sur : Clairvoyance (+1 niveau, sans concentration).",
    ...
    { nom: "Potion d'escalade", type: "Potion", rarete: "Commun", lien: false, prix: "693 po", note: "Basé sur : Marche sur les parois + Amélioration de caractéristique (+1 niveau, sans concentration).",
    ...
    { nom: "Potion de diminution", type: "Potion", rarete: "Rare", lien: false, prix: "660 po", note: "Basé sur : Agrandissement/Rétrécissement (+1 niveau, durée augmentée).",
    ...
    { nom: "Potion de souffle de feu", type: "Potion", rarete: "Peu commun", lien: false, prix: "297 po", note: "Basé sur : Souffle du dragon.",
    ...
    { nom: "Potion de forme gazeuse", type: "Potion", rarete: "Rare", lien: false, prix: "990 po", note: "Basé sur : Forme gazeuse (+1 niveau, sans concentration).",
    ...
    { nom: "Potion de force de géant des nuages", type: "Potion", rarete: "Très rare", lien: false, prix: "37 422 po", note: "Référence : ceinturon des nuages, divisé par 10.",
    ...
    { nom: "Potion de force de géant du feu", type: "Potion", rarete: "Rare", lien: false, prix: "11 643 po", note: "Référence : ceinturon du feu, divisé par 10.",
    ...
    { nom: "Potion de force de géant du givre/pierre", type: "Potion", rarete: "Rare", lien: false, prix: "8 732 po", note: "Référence : ceinturon du givre/tempête, divisé par 10.",
    ...
    { nom: "Potion de force de géant des collines", type: "Potion", rarete: "Peu commun", lien: false, prix: "3 119 po", note: "Référence : ceinturon des collines, divisé par 10.",
    ...
    { nom: "Potion de force de géant des tempêtes", type: "Potion", rarete: "Légendaire", lien: false, prix: "77 963 po", note: "Référence : ceinturon des tempêtes, divisé par 10.",
    ...
    { nom: "Potion d'invisibilité supérieure", type: "Potion", rarete: "Très rare", lien: false, prix: "3 564 po", note: "Basé sur : Invisibilité supérieure (+3 niveaux, sans concentration, dure 1 heure).",
    ...
    { nom: "Potion de croissance", type: "Potion", rarete: "Peu commun", lien: false, prix: "495 po", note: "Basé sur : Agrandissement/Rétrécissement (+1 niveau, durée augmentée).",
    ...
    { nom: "Potion d'héroïsme", type: "Potion", rarete: "Rare", lien: false, prix: "792 po", note: "Basé sur : Héroïsme + Bénédiction (+1 niveau, sans concentration).",
    ...
    { nom: "Potion d'invulnérabilité", type: "Potion", rarete: "Rare", lien: false, prix: "3 630 po", note: "Basé sur : Invulnérabilité.",
    ...
    { nom: "Potion de longévité", type: "Potion", rarete: "Très rare", lien: false, prix: "5 445 po", note: "Basé sur : Vœu.",
    ...
    { nom: "Potion de lecture des pensées", type: "Potion", rarete: "Rare", lien: false, prix: "660 po", note: "Basé sur : Détection des pensées (+1 niveau, sans concentration).",
    ...
    { nom: "Potion de pugilat", type: "Potion", rarete: "Peu commun", lien: false, prix: "248 po", note: "Non applicable",
    ...
    { nom: "Potion de résistance", type: "Potion", rarete: "Peu commun", lien: false, prix: "743 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Potion de rapidité", type: "Potion", rarete: "Très rare", lien: false, prix: "1 485 po", note: "Basé sur : Hâte (+1 niveau, sans concentration).",
    ...
    { nom: "Potion de guérison supérieure", type: "Potion", rarete: "Rare", lien: false, prix: "440 po", note: "Non applicable",
    ...
    { nom: "Potion de guérison suprême", type: "Potion", rarete: "Très rare", lien: false, prix: "1 061 po", note: "Non applicable",
    ...
    { nom: "Potion de vitalité", type: "Potion", rarete: "Très rare", lien: false, prix: "2 772 po", note: "Basé sur : Restauration supérieure (+1 niveau, effet renforcé).",
    ...
    { nom: "Potion de respiration aquatique", type: "Potion", rarete: "Peu commun", lien: false, prix: "297 po", note: "Basé sur : Respiration aquatique (niveau réduit, durée diminuée).",
    ...
    // 🪄 BAGUETTE
    { nom: "Baguette d'entrave", type: "Baguette", rarete: "Rare", lien: true, prix: "9 300 po", note: "Basé sur : Immobilisation de monstre ×1 + Immobilisation de personne ×1 + Liberté de mouvement (niveau réduit).",
    ...
    { nom: "Baguette de direction d'orchestre", type: "Baguette", rarete: "Commun", lien: false, prix: "198 po", note: "Basé sur : Thaumaturgie.",
    ...
    { nom: "Baguette de détection des ennemis", type: "Baguette", rarete: "Rare", lien: true, prix: "9 000 po", note: "Basé sur : Localisation de créature.",
    ...
    { nom: "Baguette de terreur", type: "Baguette", rarete: "Rare", lien: true, prix: "4 320 po", note: "Basé sur : Terreur ×3 + Commandement ×1.",
    ...
    { nom: "Baguette de détection de la magie", type: "Baguette", rarete: "Peu commun", lien: false, prix: "891 po", note: "Basé sur : Détection de la magie (×3 charges).",
    ...
    { nom: "Baguette d'Orcus", type: "Baguette", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Baguette de paralysie", type: "Baguette", rarete: "Rare", lien: true, prix: "16 800 po", note: "Basé sur : Immobilisation de monstre (+1 niveau, sans concentration, ×7 charges).",
    ...
    { nom: "Baguette de métamorphose", type: "Baguette", rarete: "Très rare", lien: true, prix: "13 500 po", note: "Basé sur : Métamorphose (×7 charges).",
    ...
    { nom: "Baguette de pyrotechnie", type: "Baguette", rarete: "Commun", lien: false, prix: "198 po", note: "Basé sur : Lumière.",
    ...
    { nom: "Baguette des grimaces", type: "Baguette", rarete: "Commun", lien: false, prix: "198 po", note: "Basé sur : Illusion mineure.",
    ...
    { nom: "Baguette des secrets", type: "Baguette", rarete: "Peu commun", lien: false, prix: "1 782 po", note: "Basé sur : Détection des pièges (×3 charges).",
    ...
    { nom: "Baguette des sourires", type: "Baguette", rarete: "Commun", lien: false, prix: "198 po", note: "Basé sur : Illusion mineure.",
    ...
    { nom: "Baguette du mage de guerre +1", type: "Baguette", rarete: "Peu commun", lien: true, prix: "900 po", note: "Divers : 100 po pour ignorer la couverture.",
    ...
    { nom: "Baguette du mage de guerre +2", type: "Baguette", rarete: "Rare", lien: true, prix: "3 200 po", note: "Divers : 100 po pour ignorer la couverture.",
    ...
    { nom: "Baguette du mage de guerre +3", type: "Baguette", rarete: "Très rare", lien: true, prix: "9 300 po", note: "Divers : 100 po pour ignorer la couverture.",
    ...
    { nom: "Baguette de toile d'araignée", type: "Baguette", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : Toile d'araignée (×7 charges).",
    ...
    { nom: "Baguette des merveilles", type: "Baguette", rarete: "Rare", lien: true, prix: "20 400 po", note: "Basé sur : sort de niveau 6 (×7 charges).",
    ...
    // 🔱 BÂTON
    { nom: "Bâton ensorcelé (niv. 1)", type: "Bâton", rarete: "Peu commun", lien: true, prix: "1 216 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (niv. 2)", type: "Bâton", rarete: "Rare", lien: true, prix: "3 241 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (niv. 3)", type: "Bâton", rarete: "Rare", lien: true, prix: "5 401 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (niv. 4)", type: "Bâton", rarete: "Très rare", lien: true, prix: "12 151 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (niv. 5)", type: "Bâton", rarete: "Très rare", lien: true, prix: "17 011 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (niv. 6)", type: "Bâton", rarete: "Légendaire", lien: true, prix: "37 801 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (niv. 7)", type: "Bâton", rarete: "Légendaire", lien: true, prix: "48 601 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (niv. 8)", type: "Bâton", rarete: "Légendaire", lien: true, prix: "60 751 po", note: "Non applicable",
    ...
    { nom: "Bâton ensorcelé (tour de magie)", type: "Bâton", rarete: "Peu commun", lien: true, prix: "406 po", note: "Non applicable",
    ...
    { nom: "Bâton d'ornement", type: "Bâton", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Bâton des chants d'oiseaux", type: "Bâton", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Thaumaturgie.",
    ...
    { nom: "Bâton de charme", type: "Bâton", rarete: "Rare", lien: true, prix: "7 020 po", note: "Basé sur : sort niv. 1 (10 charges), 1 utilisation/jour de sort niv. 5.",
    ...
    { nom: "Bâton de feu", type: "Bâton", rarete: "Très rare", lien: true, prix: "20 970 po", note: "Basé sur : Mur de feu ×2 + Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Bâton des fleurs", type: "Bâton", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Art druidique.",
    ...
    { nom: "Bâton de givre", type: "Bâton", rarete: "Très rare", lien: true, prix: "27 540 po", note: "Basé sur : Mur de glace ×2 + Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Bâton de guérison", type: "Bâton", rarete: "Rare", lien: true, prix: "6 780 po", note: "Basé sur : Soin de groupe (×2 charges).",
    ...
    { nom: "Bâton de frappe", type: "Bâton", rarete: "Très rare", lien: true, prix: "9 429 po", note: "Non applicable",
    ...
    { nom: "Bâton des nuées d'insectes", type: "Bâton", rarete: "Rare", lien: true, prix: "6 840 po", note: "Basé sur : Nuée d'insectes (×2).",
    ...
    { nom: "Bâton du tonnerre et de la foudre", type: "Bâton", rarete: "Très rare", lien: true, prix: "12 630 po", note: "Basé sur : Éclair (+1 niveau) + Coup de tonnerre (niveau 1).",
    ...
    { nom: "Bâton de flétrissement", type: "Bâton", rarete: "Rare", lien: true, prix: "12 960 po", note: "Basé sur : Œil de destruction (+1 niveau).",
    ...
    { nom: "Bâton de la vipère", type: "Bâton", rarete: "Peu commun", lien: true, prix: "282 po", note: "Non applicable",
    ...
    { nom: "Bâton du mage", type: "Bâton", rarete: "Légendaire", lien: true, prix: "104 250 po", note: "Basé sur : Cercle de pouvoir + sorts niv. 7 (×7 charges). Divers : sorts sans charges.",
    ...
    { nom: "Bâton du python", type: "Bâton", rarete: "Peu commun", lien: true, prix: "4 500 po", note: "Basé sur : Convocation d'animaux.",
    ...
    // ⚡ SCEPTRE
    { nom: "Sceptre d'absorption", type: "Sceptre", rarete: "Très rare", lien: true, prix: "43 650 po", note: "10 charges de sorts niv. 5, 6 utilisations de Contresort au niv. 9.",
    ...
    { nom: "Sceptre de vigilance", type: "Sceptre", rarete: "Très rare", lien: true, prix: "16 200 po", note: "Basé sur : Amélioration de caractéristique. Auras similaires au paladin niv. 7. Puissance ≈ sort niv. 4.",
    ...
    { nom: "Sceptre de puissance seigneuriale", type: "Sceptre", rarete: "Légendaire", lien: true, prix: "24 893 po", note: "Basé sur : Langue de feu. Divers : condition Effrayé.",
    ...
    { nom: "Sceptre de résurrection", type: "Sceptre", rarete: "Légendaire", lien: true, prix: "27 150 po", note: "Basé sur : Soin (×5).",
    ...
    { nom: "Sceptre de domination", type: "Sceptre", rarete: "Rare", lien: true, prix: "6 720 po", note: "Basé sur : Charme monstre (+2 niveaux).",
    ...
    { nom: "Sceptre de sécurité", type: "Sceptre", rarete: "Très rare", lien: false, prix: "22 275 po", note: "Basé sur : Manoir de Mordenkainen (+1 niveau, ×2).",
    ...
    { nom: "Sceptre du gardien du pacte +1", type: "Sceptre", rarete: "Peu commun", lien: true, prix: "2 640 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération d'emplacement de sort traitée au niveau 1.",
    ...
    { nom: "Sceptre du gardien du pacte +2", type: "Sceptre", rarete: "Rare", lien: true, prix: "9 120 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération d'emplacement de sort traitée au niveau 1.",
    ...
    { nom: "Sceptre du gardien du pacte +3", type: "Sceptre", rarete: "Très rare", lien: true, prix: "26 280 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération d'emplacement de sort traitée au niveau 1.",
    ...
    { nom: "Sceptre tentacule", type: "Sceptre", rarete: "Rare", lien: true, prix: "3 228 po", note: "Non applicable",
    ...
    // 📜 PARCHEMIN
    { nom: "Parchemin de protection", type: "Parchemin", rarete: "Rare", lien: false, prix: "198 po", note: "Basé sur : Protection contre le mal et le bien.",
    ...
    { nom: "Parchemin d'invocation des titans", type: "Parchemin", rarete: "Légendaire", lien: false, prix: "10 890 po", note: "Basé sur : sort de niveau 10.",
    ...
    { nom: "Parchemin de sort (niv. 1)", type: "Parchemin", rarete: "Commun", lien: false, prix: "99 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 2)", type: "Parchemin", rarete: "Peu commun", lien: false, prix: "297 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 3)", type: "Parchemin", rarete: "Peu commun", lien: false, prix: "495 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 4)", type: "Parchemin", rarete: "Rare", lien: false, prix: "990 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 5)", type: "Parchemin", rarete: "Rare", lien: false, prix: "1 386 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 6)", type: "Parchemin", rarete: "Très rare", lien: false, prix: "2 772 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 7)", type: "Parchemin", rarete: "Très rare", lien: false, prix: "3 564 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 8)", type: "Parchemin", rarete: "Très rare", lien: false, prix: "4 455 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (niv. 9)", type: "Parchemin", rarete: "Légendaire", lien: false, prix: "9 075 po", note: "Non applicable",
    ...
    { nom: "Parchemin de sort (tour de magie)", type: "Parchemin", rarete: "Commun", lien: false, prix: "33 po", note: "Non applicable",
...
// ════════════════════════════════════════════════════════
    ...
    { nom: "Tatouage absorbant", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "14 580 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration). Immunité basée sur Absorption des éléments.",
    ...
    { nom: "Compendium alchimique", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 680 po", note: "Alchimie traitée comme Fabrication (×3). Sorts d'échange traités au niveau 3. Sorts supplémentaires traités comme bâton. Coût additionnel : 10 po pour focaliseur.",
    ...
    { nom: "Outil polyvalent +1", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 580 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Coût moyen pour divers outils et fournitures.",
    ...
    { nom: "Outil polyvalent +2", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "9 040 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Coût moyen pour divers outils et fournitures.",
    ...
    { nom: "Outil polyvalent +3", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "26 160 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Coût moyen pour divers outils et fournitures.",
    ...
    { nom: "Amulette de protection contre la détection et la localisation", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Non applicable",
    ...
    { nom: "Amulette du dévot +1", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 640 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Canalisation divine traitée comme emplacement de sort niv. 1 supplémentaire.",
    ...
    { nom: "Amulette du dévot +2", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "9 120 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Canalisation divine traitée comme emplacement de sort niv. 1 supplémentaire.",
    ...
    { nom: "Amulette du dévot +3", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "26 280 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Canalisation divine traitée comme emplacement de sort niv. 1 supplémentaire.",
    ...
    { nom: "Amulette des plans", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "32 400 po", note: "Non applicable",
    ...
    { nom: "Appareil de Kwalish", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "137 500 po", note: "Non applicable",
    ...
    { nom: "Grimoire arcanique +1", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 640 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération arcanique supplémentaire traitée comme emplacement niv. 1.",
    ...
    { nom: "Grimoire arcanique +2", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "9 120 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération arcanique supplémentaire traitée comme emplacement niv. 1.",
    ...
    { nom: "Grimoire arcanique +3", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "26 280 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération arcanique supplémentaire traitée comme emplacement niv. 1.",
    ...
    { nom: "Éclat astral", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 020 po", note: "Pas brumeux à volonté (+1 niveau, sans coût d'action). Coût additionnel pour focaliseur.",
    ...
    { nom: "Archives d'astromancie", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "5 360 po", note: "Sorts d'échange traités au niveau 3 (×3). Réaction traitée comme sort niv. 2. Sorts supplémentaires traités comme bâton. Coût additionnel : 10 po pour focaliseur.",
    ...
    { nom: "Atlas des horizons sans fin", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 080 po", note: "Sorts d'échange traités au niveau 3 (×3). Réaction traitée comme sort niv. 2 ajouté aux sorts supplémentaires. Traités comme bâton. Coût additionnel : 10 po pour focaliseur.",
    ...
    { nom: "Balai dansant de Baba Yaga", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : Arme spirituelle.",
    ...
    { nom: "Sac de haricots", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "— po", note: "Effets aléatoires — prix non défini.",
    ...
    { nom: "Sac dévoreur", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "— po", note: "Maudit(e) — prix non défini.",
    ...
    { nom: "Sac sans fond", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 485 po", note: "Basé sur : Disque flottant.",
    ...
    { nom: "Sac à malices", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "4 455 po", note: "Basé sur : Convocation d'animaux (+1 niveau, sans concentration, monstre max FP 2).",
    ...
    { nom: "Tatouage de barrière (CA 12+Dex)", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "1 350 po", note: "Basé sur : Armure du mage.",
    ...
    { nom: "Tatouage de barrière (CA 15+Dex)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "3 600 po", note: "Basé sur : Peau d'écorce.",
    ...
    { nom: "Tatouage de barrière (CA 18)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "9 000 po", note: "Basé sur : sort de niveau 3.",
    ...
    { nom: "Perle de force", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "13 933 po", note: "Basé sur : Sphère résiliente (+1 niveau, sans concentration). Charges par perle.",
    ...
    { nom: "Perle de nourrissement", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "99 po", note: "Basé sur : Baies nourricières.",
    ...
    { nom: "Perle de rafraîchissement", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "99 po", note: "Basé sur : Création ou destruction d'eau.",
    ...
    { nom: "Branche à clochettes", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 160 po", note: "Basé sur : sort de protection (×3) + Détection du mal et du bien. Coût additionnel : focaliseur.",
    ...
    { nom: "Ceinturon de force de géant des nuages", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "113 400 po", note: "Non applicable",
    ...
    { nom: "Ceinturon de force de géant du feu", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "52 920 po", note: "Non applicable",
    ...
    { nom: "Ceinturon de force de géant des collines", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "18 900 po", note: "Non applicable",
    ...
    { nom: "Ceinturon de force de géant de pierre/givre", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "39 690 po", note: "Non applicable",
    ...
    { nom: "Ceinturon de force de géant des tempêtes", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "141 750 po", note: "Non applicable",
    ...
    { nom: "Blackrazor", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Tatouage de fureur sanguinaire", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "27 000 po", note: "Réaction traitée comme Représailles infernales. Dégâts nécrotiques comme Contact vampirique (+1 niveau).",
    ...
    { nom: "Fiole du puits de sang +1", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "3 900 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Points de sort supplémentaires = sort niv. 3.",
    ...
    { nom: "Fiole du puits de sang +2", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "10 800 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Points de sort supplémentaires = sort niv. 3.",
    ...
    { nom: "Fiole du puits de sang +3", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "28 800 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Points de sort supplémentaires = sort niv. 3.",
    ...
    { nom: "Livre des actes exaltés", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Livre des ténèbres viles", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Bottes de fausses pistes", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Déguisement illusoire (niveau réduit).",
    ...
    { nom: "Bottes de lévitation", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "3 600 po", note: "Basé sur : Lévitation.",
    ...
    { nom: "Bottes de rapidité", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 800 po", note: "Basé sur : Frappe du zéphyr.",
    ...
    { nom: "Bottes de course et de bonds", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "1 350 po", note: "Basé sur : Saut.",
    ...
    { nom: "Bottes des terres hivernales", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "4 050 po", note: "Basé sur : Liberté de mouvement (-2 niveaux).",
    ...
    { nom: "Brassards d'archerie", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 250 po", note: "Non applicable",
    ...
    { nom: "Brassards de défense", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "5 400 po", note: "Non applicable",
    ...
    { nom: "Brasero de commandement des élémentaires de feu", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "7 392 po", note: "Basé sur : Convocation d'élémentaire (+1 niveau, sans concentration).",
    ...
    { nom: "Balai volant", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "4 500 po", note: "Basé sur : Vol.",
    ...
    { nom: "Chandelle d'invocation", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "28 350 po", note: "Basé sur : Portail + Gardien de la nature (illimité).",
    ...
    { nom: "Chandelle des abysses", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Lumière.",
    ...
    { nom: "Bonnet de respiration aquatique", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "4 950 po", note: "Basé sur : Respiration aquatique.",
    ...
    { nom: "Cape du charlatan", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 960 po", note: "Basé sur : Porte dimensionnelle.",
    ...
    { nom: "Tapis volant (3x5)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "14 850 po", note: "Basé sur : Vol, 1 créature (+1 niveau, sans concentration).",
    ...
    { nom: "Tapis volant (4x6)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "29 700 po", note: "Basé sur : Vol, 2 créatures (+1 niveau, sans concentration).",
    ...
    { nom: "Tapis volant (5x7)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "44 550 po", note: "Basé sur : Vol, 3 créatures (+1 niveau, sans concentration).",
    ...
    { nom: "Tapis volant (6x9)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "59 400 po", note: "Basé sur : Vol, 4 créatures (+1 niveau, sans concentration).",
    ...
    { nom: "Chaudron de renaissance", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "10 860 po", note: "Basé sur : Rappel à la vie. Coût additionnel : focaliseur de scrutation.",
    ...
    { nom: "Encensoir de contrôle des élémentaires d'air", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "7 392 po", note: "Basé sur : Convocation d'élémentaire (+1 niveau, sans concentration).",
    ...
    { nom: "Dé du charlatan", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "300 po", note: "Basé sur : Illusion mineure.",
    ...
    { nom: "Carillon d'ouverture", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "4 320 po", note: "Basé sur : Débloquer.",
    ...
    { nom: "Cerceau de déflagration", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 188 po", note: "Basé sur : Rayon ardent.",
    ...
    { nom: "Cape de l'araignée", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "12 780 po", note: "Basé sur : Marche sur les parois (+1 niveau, sans concentration) + Toile d'araignée.",
    ...
    { nom: "Cape flottante", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Bourrasque.",
    ...
    { nom: "Cape elfique", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "9 000 po", note: "Basé sur : Amélioration de caractéristique ×2 (+1 niveau, sans concentration).",
    ...
    { nom: "Cape d'invisibilité", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "42 000 po", note: "Basé sur : Invisibilité supérieure (+1 niveau, sans concentration, 2h ≈ permanent).",
    ...
    { nom: "Cape aux multiples apparences", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "990 po", note: "Basé sur : Déguisement illusoire.",
    ...
    { nom: "Amulette mécanique", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "792 po", note: "Basé sur : puissance de sort niv. 2.",
    ...
    { nom: "Vêtements de réparation", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Réparation.",
    ...
    { nom: "Tatouage d'emprise enroulante", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "849 po", note: "Non applicable",
    ...
    { nom: "Boule de cristal", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "18 900 po", note: "Basé sur : Scrutation.",
    ...
    { nom: "Boule de cristal de lecture des pensées", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "36 000 po", note: "Basé sur : Scrutation + Détection des pensées.",
    ...
    { nom: "Boule de cristal de télépathie", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "33 300 po", note: "Basé sur : Scrutation + Suggestion.",
    ...
    { nom: "Boule de cristal de vision véritable", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "73 500 po", note: "Basé sur : Scrutation + Vision véritable.",
    ...
    { nom: "Chronique cristalline", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "10 290 po", note: "Sorts d'échange traités au niveau 3 (×3). Sort subtil au niveau 3. Sorts supplémentaires traités comme bâton. Coût : 10 po focaliseur + 300 po tour de magie à volonté.",
    ...
    { nom: "Cube de force", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "17 880 po", note: "Basé sur : Mur de force (+1 niveau, sans concentration).",
    ...
    { nom: "Cube d'invocation", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "7 392 po", note: "Basé sur : sort de niveau 6 (+1 niveau, sans concentration).",
    ...
    { nom: "Portail cubique", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "60 390 po", note: "Basé sur : Portail + Changement de plan (charges selon niveau le plus élevé).",
    ...
    { nom: "Forteresse instantanée de Daern", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "16 800 po", note: "Basé sur : Manoir de Mordenkainen (niveau réduit).",
    ...
    { nom: "Amulette d'éclat sombre", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "120 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Carafe d'eau sans fin", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 570 po", note: "Basé sur : Création ou destruction d'eau.",
    ...
    { nom: "Jeu d'illusions", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "16 200 po", note: "Basé sur : Grande image (charges selon le nombre de cartes).",
    ...
    { nom: "Jeu de nombreuses choses", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "— po", note: "Légendaire — prix non défini.",
    ...
    { nom: "Défenseur", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "15 000 po", note: "Non applicable",
    ...
    { nom: "Demonomicon d'Iggwilv", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Encensoir du dévot", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 734 po", note: "Soin traité comme Moy2 × 4 créatures × 10 rounds. Coût additionnel : focaliseur.",
    ...
    { nom: "Entraves dimensionnelles", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "9 900 po", note: "Basé sur : Contresort (+1 niveau).",
    ...
    { nom: "Pourfendeur de dragons", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 886 po", note: "Non applicable",
    ...
    { nom: "Heaume de terreur", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Illusion mineure.",
    ...
    { nom: "Globe flottant", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "2 475 po", note: "Basé sur : Lumière + Lumière du jour.",
    ...
    { nom: "Manuscrit trompeur", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "4 820 po", note: "Sorts d'échange traités au niv. 3 (×3). Réaction au niv. 1 (Barbes argentées). Sorts supplémentaires traités comme bâton. Coût : 10 po focaliseur.",
    ...
    { nom: "Poudre de disparition", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "2 970 po", note: "Basé sur : Invisibilité (+1 niveau, sans concentration, ×4 pour zone d'effet).",
    ...
    { nom: "Poudre d'éternuement et d'étouffement", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "— po", note: "Maudit(e) — prix non défini.",
    ...
    { nom: "Lanceuse naine", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "9 964 po", note: "Non applicable",
    ...
    { nom: "Cornet acoustique", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "990 po", note: "Basé sur : Restauration inférieure (niveau réduit, effet moindre).",
    ...
    { nom: "Bouteille de l'efrit", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "32 670 po", note: "Basé sur : Convocation d'élémentaire (niveau 9).",
    ...
    { nom: "Chaîne de l'efrit", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "81 750 po", note: "Basé sur : Protection primordiale (+1 niveau, sans concentration).",
    ...
    { nom: "Tatouage de griffe occulte", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "1 371 po", note: "Allonge de portée traitée comme un sort niv. 1.",
    ...
    { nom: "Éclat d'essence élémentaire (air)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "3 620 po", note: "Traité comme Vol illimité (-1 niveau, effet limité). Coût additionnel : focaliseur.",
    ...
    { nom: "Éclat d'essence élémentaire (terre)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 020 po", note: "Traité comme Protection contre les éléments illimitée (-1 niveau, effet limité). Coût additionnel : focaliseur.",
    ...
    { nom: "Éclat d'essence élémentaire (feu)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "806 po", note: "Coût additionnel : focaliseur.",
    ...
    { nom: "Éclat d'essence élémentaire (eau)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 581 po", note: "Dégâts de zone multipliés par 4 (taille de l'effet). Coût additionnel : focaliseur.",
    ...
    { nom: "Gemme élémentaire", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 386 po", note: "Basé sur : Convocation d'élémentaire (+1 niveau, sans concentration).",
    ...
    { nom: "Chaîne elfique", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "2 200 po", note: "Non applicable",
    ...
    { nom: "Grimoire durable", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Réparation.",
    ...
    { nom: "Œil de remplacement", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "990 po", note: "Basé sur : Restauration inférieure (niveau réduit, effet moindre).",
    ...
    { nom: "Bouteille fumante perpétuelle", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "2 970 po", note: "Basé sur : Nuage brumeux (+1 niveau, sans concentration).",
    ...
    { nom: "Œil et main de Vecna", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Yeux de charme", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "810 po", note: "Basé sur : Charme personne.",
    ...
    { nom: "Yeux de vision minutieuse", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "4 950 po", note: "Basé sur : Amélioration de caractéristique (+1 niveau, sans concentration).",
    ...
    { nom: "Yeux de l'aigle", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "4 500 po", note: "Basé sur : Amélioration de caractéristique (+1 niveau, sans concentration).",
    ...
    { nom: "Éclat du Royaume Lointain", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "736 po", note: "Coût additionnel : focaliseur.",
    ...
    { nom: "Éclat du Féywilde", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "4 515 po", note: "Magie sauvage traitée comme sort niv. 3. Coût additionnel : focaliseur.",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (chien)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 584 po", note: "Basé sur : Convocation d'animaux (niveau réduit).",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (éléphant)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "7 392 po", note: "Basé sur : Convocation d'animaux (+3 niveaux).",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (mouche dorée)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 584 po", note: "Basé sur : Convocation d'animaux (niveau réduit).",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (chèvres)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "2 376 po", note: "Prix pour les 3 figurines. Basé sur : Convocation d'animaux (niveau réduit).",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (griffon)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 960 po", note: "Basé sur : Convocation d'animaux (+1 niveau, sans concentration).",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (lions)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 300 po", note: "Prix pour les 2 figurines. Basé sur : Convocation d'animaux.",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (hibou)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 584 po", note: "Basé sur : Convocation d'animaux (niveau réduit).",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (corbeau)", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 188 po", note: "Basé sur : Convocation d'animaux (niveau réduit).",
    ...
    { nom: "Figurine aux pouvoirs merveilleux (destrier)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "8 316 po", note: "Basé sur : Convocation d'animaux (+2 niveaux).",
    ...
    { nom: "Barque pliante", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "8 800 po", note: "Basé sur les prix de navires du DMG.",
    ...
    { nom: "Marque de givre", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "14 143 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration).",
    ...
    { nom: "Traité fulminant", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "5 190 po", note: "Sorts d'échange traités au niveau 3 (×3). Sorts supplémentaires traités comme bâton. Coût additionnel : 10 po pour focaliseur.",
    ...
    { nom: "Gemme de lumière", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "4 851 po", note: "Basé sur : Lumière + Jet de couleurs.",
    ...
    { nom: "Gemme de vision", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "10 080 po", note: "Basé sur : Vision véritable.",
    ...
    { nom: "Tatouage du pas fantomatique", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "3 240 po", note: "Basé sur : Clignotement (-1 niveau, durée et effet réduits).",
    ...
    { nom: "Pourfendeur de géants", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 716 po", note: "Non applicable",
    ...
    { nom: "Armure de cuir clouté glamorisée", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "4 158 po", note: "Basé sur : Déguisement illusoire.",
    ...
    { nom: "Gants d'arrêt des projectiles", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : puissance de sort niv. 2 (les moines y accèdent au niv. 3).",
    ...
    { nom: "Gants de natation et d'escalade", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "9 000 po", note: "Basé sur : Altération personnelle + Marche sur les parois (+1 niveau, sans concentration).",
    ...
    { nom: "Gants de malfaiteur", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "4 950 po", note: "Basé sur : Amélioration de caractéristique (+1 niveau, sans concentration).",
    ...
    { nom: "Lunettes de nuit", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "2 970 po", note: "Basé sur : Vision dans le noir.",
    ...
    { nom: "Emblème gardien", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "825 po", note: "Basé sur : Bouclier. Coût additionnel : focaliseur.",
    ...
    { nom: "Œil de sorcière", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "6 930 po", note: "Basé sur : Scrutation (-2 niveaux, très limité). Coût réel joueur : 1 980 po sans scrutation.",
    ...
    { nom: "Chapeau de déguisement", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : Déguisement illusoire (+1 niveau, sans concentration).",
    ...
    { nom: "Chapeau aux sorts multiples", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "21 000 po", note: "Coût divers : 1 000 po matériaux × charges illimitées (7).",
    ...
    { nom: "Chapeau à vermine", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "594 po", note: "Basé sur : Convocation d'animaux (-2 niveaux).",
    ...
    { nom: "Chapeau du magicien", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "120 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Manuel du tisserand de cœurs", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "5 240 po", note: "Sorts d'échange traités au niv. 3 (×3). Réaction au niv. 1 (Barbes argentées). Sorts supplémentaires traités comme bâton. Coût : 10 po focaliseur.",
    ...
    { nom: "Heaume d'éclat", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "125 850 po", note: "Calculé avec gemmes max (21 000 po pour ×70 sorts niv. 3, 9 000 po pour ×20 sorts niv. 4).",
    ...
    { nom: "Heaume de compréhension des langues", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 485 po", note: "Basé sur : Compréhension des langues.",
    ...
    { nom: "Heaume de télépathie", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 430 po", note: "Basé sur : Détection des pensées + Suggestion.",
    ...
    { nom: "Heaume de téléportation", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "12 960 po", note: "Basé sur : Téléportation.",
    ...
    { nom: "Havresac commode de Heward", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 960 po", note: "Basé sur : Disque flottant ×2.",
    ...
    { nom: "Sachet d'épices commode de Heward", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Prestidigitation.",
    ...
    { nom: "Cor de déflagration", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "2 005 po", note: "Consommable mais probablement réutilisable plusieurs fois.",
    ...
    { nom: "Cor d'alarme silencieuse", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "693 po", note: "Basé sur : Message (+1 niveau).",
    ...
    { nom: "Cor de Valhalla (argent)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "14 520 po", note: "Basé sur : Convocation d'animaux (moyenne 7 invoqués).",
    ...
    { nom: "Cor de Valhalla (laiton)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "21 780 po", note: "Basé sur : Convocation d'animaux (moyenne 10 invoqués).",
    ...
    { nom: "Cor de Valhalla (bronze)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "38 115 po", note: "Basé sur : Convocation d'animaux (moyenne 14 invoqués).",
    ...
    { nom: "Cor de Valhalla (fer)", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "72 600 po", note: "Basé sur : Convocation d'animaux (moyenne 17 invoqués).",
    ...
    { nom: "Fers à cheval de rapidité", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 960 po", note: "Basé sur : Foulée du chasseur (+1 niveau).",
    ...
    { nom: "Fers à cheval du zéphyr", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "5 940 po", note: "Basé sur : Liberté de mouvement (-2 niveaux).",
    ...
    { nom: "Tatouage de l'enlumineur", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "660 po", note: "Basé sur : Écriture illusoire (×1/jour) + écriture au doigt comme tour de magie.",
    ...
    { nom: "Instrument d'illusions", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "300 po", note: "Basé sur : Illusion mineure.",
    ...
    { nom: "Instrument de scription", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "180 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Instrument des bardes (harpe d'Anstruth)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "42 840 po", note: "Divers : 3 000 po pour Vol, Invisibilité, Lévitation, Protection mal/bien.",
    ...
    { nom: "Instrument des bardes (mandoline de Canaith)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "13 200 po", note: "Divers : 3 000 po pour Vol, Invisibilité, Lévitation, Protection mal/bien.",
    ...
    { nom: "Instrument des bardes (lyre de Cli)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "15 600 po", note: "Divers : 3 000 po pour Vol, Invisibilité, Lévitation, Protection mal/bien.",
    ...
    { nom: "Instrument des bardes (luth de Doss)", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "7 920 po", note: "Divers : 3 000 po pour Vol, Invisibilité, Lévitation, Protection mal/bien.",
    ...
    { nom: "Instrument des bardes (bandore de Fochlucan)", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "6 300 po", note: "Divers : 3 360 po pour Vol, Invisibilité, Lévitation, Protection mal/bien, Communication animaux.",
    ...
    { nom: "Instrument des bardes (cistre de Mac-Fuirmidh)", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "6 660 po", note: "Divers : 3 000 po pour Vol, Invisibilité, Lévitation, Protection mal/bien.",
    ...
    { nom: "Instrument des bardes (harpe d'Ollamh)", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "72 600 po", note: "Divers : 3 000 po pour Vol, Invisibilité, Lévitation, Protection mal/bien.",
...
{ nom: "Pierre d'Ioun (absorption)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "6 750 po", note: "Basé sur : Contresort (+1 niveau). Charges selon le niveau le plus élevé.",
    ...
    { nom: "Pierre d'Ioun (agilité)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "1 890 po", note: "Non applicable",
    ...
    { nom: "Pierre d'Ioun (conscience)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 800 po", note: "Basé sur : Alarme.",
    ...
    { nom: "Pierre d'Ioun (endurance)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "1 890 po", note: "Non applicable",
    ...
    { nom: "Pierre d'Ioun (absorption supérieure)", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "47 250 po", note: "Basé sur : Contresort (+5 niveaux). Charges selon le niveau le plus élevé.",
    ...
    { nom: "Pierre d'Ioun (perspicacité)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "1 890 po", note: "Non applicable",
    ...
    { nom: "Pierre d'Ioun (intellect)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "1 890 po", note: "Non applicable",
    ...
    { nom: "Pierre d'Ioun (commandement)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "1 890 po", note: "Non applicable",
    ...
    { nom: "Pierre d'Ioun (maîtrise)", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "82 500 po", note: "Basé sur : Vœu.",
    ...
    { nom: "Pierre d'Ioun (protection)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 800 po", note: "Non applicable",
    ...
    { nom: "Pierre d'Ioun (régénération)", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "15 000 po", note: "Basé sur : Soin des blessures (+2 niveaux, 24 charges/jour).",
    ...
    { nom: "Pierre d'Ioun (force)", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "1 890 po", note: "Non applicable",
    ...
    { nom: "Pierre d'Ioun (subsistance)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 800 po", note: "Basé sur : Baies nourricières.",
    ...
    { nom: "Bandes de fer de Bilarro", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 980 po", note: "Basé sur la condition entravé, multiplié par 10.",
    ...
    { nom: "Flasque de fer", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "24 750 po", note: "Basé sur : Charme monstre (pour fiole vide).",
    ...
    { nom: "Onguent de Keoghtom", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 391 po", note: "Prix pour 5 doses.",
    ...
    { nom: "Lanterne de révélation", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "4 950 po", note: "Basé sur : Détection de l'invisibilité (+1 niveau).",
    ...
    { nom: "Libram des âmes et de la chair", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "5 240 po", note: "Sorts d'échange traités au niveau 3 (×3). Morts-vivants indifférents traités comme sort niv. 1. Sorts supplémentaires traités comme bâton. Coût : 10 po focaliseur.",
    ...
    { nom: "Tatouage du puits de vie", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "18 900 po", note: "Basé sur : Protection contre l'énergie (+1 niveau, sans concentration) + Garde contre la mort.",
    ...
    { nom: "Verrou de tromperie", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "990 po", note: "Basé sur : Fléau (approximativement).",
    ...
    { nom: "Luth de fracas tonnant", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "11 550 po", note: "Traiter comme une arme +3 (le bonus de Charisme d'un barde dépasse généralement sa Force du même montant).",
    ...
    { nom: "Lyre de construction", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "23 160 po", note: "Basé sur : Réparation + réaction comme Bouclier (+1 niveau). Coût inclut des sorts supplémentaires ×1/jour.",
    ...
    { nom: "Manteau de résistance aux sorts", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "9 000 po", note: "Basé sur : Cercle de pouvoir (niveau réduit).",
    ...
    { nom: "Manuel d'exercice profitable", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "43 659 po", note: "Augmente également le maximum de la caractéristique (score fixé).",
    ...
    { nom: "Manuel des golems (argile)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "16 335 po", note: "Basé sur : Convocation d'élémentaire (niveau 9).",
    ...
    { nom: "Manuel des golems (chair)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "6 237 po", note: "Basé sur : Convocation d'élémentaire.",
    ...
    { nom: "Manuel des golems (fer)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "27 225 po", note: "Basé sur : Convocation d'élémentaire ×3 (niveau 9).",
    ...
    { nom: "Manuel des golems (pierre)", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "21 780 po", note: "Basé sur : Convocation d'élémentaire ×2 (niveau 9).",
    ...
    { nom: "Manuel de vivacité", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "43 659 po", note: "Augmente également le maximum de la caractéristique (score fixé).",
    ...
    { nom: "Tatouage de mascarade", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "660 po", note: "Basé sur : Encre fluide (tour de magie) + Déguisement illusoire (×1/jour).",
    ...
    { nom: "Médaillon des pensées", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 160 po", note: "Basé sur : Détection des pensées.",
    ...
    { nom: "Miroir de capture des âmes", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "20 790 po", note: "Basé sur : Bannissement (×12 charges).",
    ...
    { nom: "Clé mystérieuse", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "99 po", note: "Basé sur : Débloquer (niveau réduit).",
    ...
    { nom: "Manteau de la nature", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : Invisibilité.",
    ...
    { nom: "Collier d'adaptation", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "9 000 po", note: "Basé sur : Respiration aquatique + Protection contre le poison.",
    ...
    { nom: "Collier de perles de prière (bénédiction)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "1 440 po", note: "Basé sur : Bénédiction (+1 niveau, action bonus).",
    ...
    { nom: "Collier de perles de prière (guérison)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "2 400 po", note: "Basé sur : Soin des blessures + Restauration inférieure (+1 niveau, action bonus).",
    ...
    { nom: "Collier de perles de prière (faveur divine)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 720 po", note: "Basé sur : Restauration supérieure (+1 niveau, action bonus).",
    ...
    { nom: "Collier de perles de prière (châtiment)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "2 400 po", note: "Basé sur : Châtiment flamboyant (+1 niveau, action bonus).",
    ...
    { nom: "Collier de perles de prière (convocation)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "8 640 po", note: "Basé sur : Allié planaire (+1 niveau, action bonus).",
    ...
    { nom: "Collier de perles de prière (marche du vent)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "8 640 po", note: "Basé sur : Marche du vent (+1 niveau, action bonus).",
    ...
    { nom: "Voleur des neuf vies", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "40 950 po", note: "9 charges. Basé sur : Mot de pouvoir mort (niveau réduit, jet de sauvegarde).",
    ...
    { nom: "Pigments merveilleux de Nolzur", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "14 850 po", note: "Par pot. Basé sur : Fabrication (permanent).",
    ...
    { nom: "Huile d'éthéralité", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "2 376 po", note: "Non applicable",
    ...
    { nom: "Huile de tranchant", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "2 772 po", note: "Basé sur : Arme magique.",
    ...
    { nom: "Huile de glissance", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "743 po", note: "Basé sur : Liberté de mouvement.",
    ...
    { nom: "Orbe de direction", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Orbe des dracoïdes", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Orbe du temps", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Éclat d'essence des plans extérieurs (chaos)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 020 po", note: "Basé sur : Flou (illimité, +1 niveau pour effet accru). Coût additionnel : focaliseur.",
    ...
    { nom: "Éclat d'essence des plans extérieurs (mal)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "734 po", note: "Coût additionnel : focaliseur.",
    ...
    { nom: "Éclat d'essence des plans extérieurs (bien)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "3 620 po", note: "Basé sur : Fausse vie (niv. 2). Coût additionnel : focaliseur.",
    ...
    { nom: "Éclat d'essence des plans extérieurs (loi)", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "12 620 po", note: "Basé sur : Restauration supérieure (illimitée). Coût additionnel : focaliseur.",
    ...
    { nom: "Perle de puissance", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : sorts de niveau 4.",
    ...
    { nom: "Parfum d'envoûtement", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "198 po", note: "Basé sur : Amélioration de caractéristique.",
    ...
    { nom: "Périapte de santé", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "2 970 po", note: "Basé sur : Restauration inférieure.",
    ...
    { nom: "Périapte de protection contre le poison", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 000 po", note: "Basé sur : Protection contre le poison (+1 niveau).",
    ...
    { nom: "Périapte de cicatrisation", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 700 po", note: "Basé sur : Stabilisation (augmenté de 2 niveaux).",
    ...
    { nom: "Pipe à monstres de fumée", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Illusion mineure.",
    ...
    { nom: "Flûteaux de hantise", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "2 970 po", note: "Basé sur : Terreur (niveau 3).",
    ...
    { nom: "Flûteaux des égouts", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "1 620 po", note: "Basé sur : Convocation d'animaux (niveau réduit).",
    ...
    { nom: "Codex de l'invocateur des plans", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "5 240 po", note: "Sorts d'échange traités au niveau 3 (×3). Avantage aux attaques comme Lien animal. Sorts supplémentaires traités comme bâton. Coût : 10 po focaliseur.",
    ...
    { nom: "Perche de pêche", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Perche rétractable", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Trou portable", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 960 po", note: "Basé sur : Disque flottant (+1 niveau, capacité augmentée).",
    ...
    { nom: "Pot d'éveil", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "198 po", note: "Basé sur : Convocation d'animaux (niveau réduit).",
    ...
    { nom: "Membre prothétique", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Main du mage.",
    ...
    { nom: "Versets protecteurs", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "5 240 po", note: "Sorts d'échange traités au niveau 3 (×3). PV temporaires traités comme Fausse vie. Sorts supplémentaires traités comme bâton. Coût : 10 po focaliseur.",
    ...
    { nom: "Jeton-plume de Quaal (ancre)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "2 376 po", note: "Basé sur : Immobilisation de monstre (+2 niveaux pour la durée, sans concentration).",
    ...
    { nom: "Jeton-plume de Quaal (oiseau)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 630 po", note: "Basé sur : Convocation d'élémentaire (niveau 9).",
    ...
    { nom: "Jeton-plume de Quaal (éventail)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "660 po", note: "Basé sur : Bourrasque (+1 niveau, sans concentration).",
    ...
    { nom: "Jeton-plume de Quaal (barque-cygne)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "660 po", note: "Basé sur les coûts d'embarcations similaires.",
    ...
    { nom: "Jeton-plume de Quaal (arbre)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "660 po", note: "Basé sur : Art druidique (permanent).",
    ...
    { nom: "Carquois d'Ehlonna", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "495 po", note: "Basé sur : Disque flottant (niveau réduit, capacité réduite).",
    ...
    { nom: "Concertina du fêtard", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "12 120 po", note: "Basé sur : Danse irrésistible. DD du sort = bonus de CA.",
    ...
    { nom: "Tambour du rythmiste +1", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 640 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération d'inspiration traitée comme sort niv. 1.",
...
{ nom: "Tambour du rythmiste +2", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "9 120 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération d'inspiration traitée comme sort niv. 1.",
    ...
    { nom: "Tambour du rythmiste +3", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "26 280 po", note: "DD du sort = bonus de CA. Attaque de sort = bonus d'arme. Récupération d'inspiration traitée comme sort niv. 1.",
    ...
    { nom: "Pièce de rivalité", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "132 po", note: "Basé sur : Raillerie acerbe.",
    ...
    { nom: "Robe des yeux", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "20 400 po", note: "Basé sur : Amélioration de caractéristique + Vision véritable.",
    ...
    { nom: "Robe des couleurs scintillantes", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "6 750 po", note: "Basé sur : Invisibilité.",
    ...
    { nom: "Robe des étoiles", type: "Objet merveilleux", rarete: "Très rare", lien: true, prix: "19 710 po", note: "Non applicable",
    ...
    { nom: "Robe des objets utiles", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "— po", note: "Matériaux bruts de la cape × 1,65 (majoration rareté et harmonisation).",
    ...
    { nom: "Robe de l'archimage", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "43 500 po", note: "Basé sur : Cercle de pouvoir (niveau réduit). Bonus CA = 15+Dex (différence entre Armure du mage et CA 15).",
    ...
    { nom: "Corde d'escalade", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "495 po", note: "Basé sur : Main du mage.",
    ...
    { nom: "Corde d'enchevêtrement", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "198 po", note: "Non applicable",
    ...
    { nom: "Corde de réparation", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Réparation.",
    ...
    { nom: "Rubis du mage de guerre", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "300 po", note: "Basé sur : puissance de tour de magie.",
    ...
    { nom: "Selle du cavalier", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "4 950 po", note: "Basé sur : Protection contre le mal et le bien (+2 niveaux, sans concentration, impossible d'être désarçonné).",
    ...
    { nom: "Scarabée de protection", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "60 300 po", note: "Basé sur : Cercle de pouvoir (niveau réduit) + effet additionnel basé sur ×12 sorts niv. 5.",
    ...
    { nom: "Pierres de transmission", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 188 po", note: "Basé sur : Envoi (niveau réduit, portée limitée).",
    ...
    { nom: "Tatouage de la marque des Ombres", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 480 po", note: "Basé sur : Vision dans le noir (×3) + Amélioration de caractéristique. Défense d'ombre comme Bouclier.",
    ...
    { nom: "Éclat des Ombres", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 020 po", note: "Basé sur : désavantage comme Malédiction. Coût additionnel : focaliseur.",
    ...
    { nom: "Chaussons d'araignée", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "4 500 po", note: "Basé sur : Marche sur les parois (+1 niveau, sans concentration).",
    ...
    { nom: "Colle souveraine", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "17 325 po", note: "Prix pour 7 utilisations. Basé sur : Fabrication.",
    ...
    { nom: "Tatouage enchanté (tour de magie)", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "99 po", note: "Tour de magie (+1 niveau car utilisable par n'importe qui).",
    ...
    { nom: "Tatouage enchanté (niv. 1)", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "198 po", note: "Sort niv. 1 (+1 niveau car utilisable par n'importe qui).",
    ...
    { nom: "Tatouage enchanté (niv. 2)", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "495 po", note: "Sort niv. 2 (+1 niveau car utilisable par n'importe qui).",
    ...
    { nom: "Tatouage enchanté (niv. 3)", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "743 po", note: "Sort niv. 3 (+1 niveau car utilisable par n'importe qui).",
    ...
    { nom: "Tatouage enchanté (niv. 4)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 386 po", note: "Sort niv. 4 (+1 niveau car utilisable par n'importe qui).",
    ...
    { nom: "Tatouage enchanté (niv. 5)", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "1 848 po", note: "Sort niv. 5 (+1 niveau car utilisable par n'importe qui).",
    ...
    { nom: "Sphère d'annihilation", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "46 200 po", note: "Basé sur : Désintégration.",
    ...
    { nom: "Tableau spirite", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "13 167 po", note: "Non applicable",
    ...
    { nom: "Pierre de contrôle des élémentaires de terre", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "7 392 po", note: "Basé sur : Convocation d'élémentaire (+1 niveau, sans concentration).",
    ...
    { nom: "Pierre de chance", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "2 100 po", note: "Bonus de caractéristique = bonus d'arme.",
    ...
    { nom: "Serre sylvestre", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "420 po", note: "Basé sur : Compréhension des langues (niveau réduit, portée limitée) + Message.",
    ...
    { nom: "Talisman du bien absolu", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "65 250 po", note: "Fissure équivalant à un sort de niveau 9.",
    ...
    { nom: "Talisman du mal absolu", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "57 000 po", note: "Fissure équivalant à un sort de niveau 9.",
    ...
    { nom: "Talisman de la sphère", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "15 000 po", note: "Basé sur : Amélioration de caractéristique (+1 niveau).",
    ...
    { nom: "Poupée parlante", type: "Objet merveilleux", rarete: "Commun", lien: true, prix: "900 po", note: "Basé sur : Bouche magique (niveau réduit).",
    ...
    { nom: "Chope de sobriété", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "330 po", note: "Basé sur : Prestidigitation.",
    ...
    { nom: "Tome de pensée claire", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "43 659 po", note: "Augmente également le maximum de la caractéristique (score fixé).",
    ...
    { nom: "Tome de commandement et d'influence", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "43 659 po", note: "Augmente également le maximum de la caractéristique (score fixé).",
    ...
    { nom: "Tome de compréhension", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "43 659 po", note: "Augmente également le maximum de la caractéristique (score fixé).",
    ...
    { nom: "Tome de la langue figée", type: "Objet merveilleux", rarete: "Légendaire", lien: true, prix: "33 000 po", note: "Traité au niveau 9 pour action bonus.",
    ...
    { nom: "Solvant universel", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "4 620 po", note: "Basé sur : Désintégration.",
    ...
    { nom: "Canne du vétéran", type: "Objet merveilleux", rarete: "Commun", lien: false, prix: "99 po", note: "Basé sur : Déguisement illusoire.",
    ...
    { nom: "Vague", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Puits des nombreux mondes", type: "Objet merveilleux", rarete: "Légendaire", lien: false, prix: "47 520 po", note: "Basé sur : Changement de plan (×5).",
    ...
    { nom: "Écraseur", type: "Objet merveilleux", rarete: "Artefact", lien: true, prix: "— po", note: "Artefact — prix non défini.",
    ...
    { nom: "Éventail du vent", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 188 po", note: "Basé sur : Bourrasque.",
    ...
    { nom: "Bottes ailées", type: "Objet merveilleux", rarete: "Peu commun", lien: true, prix: "4 725 po", note: "Basé sur : Vol (+1 niveau, sans concentration).",
    ...
    { nom: "Ailes du vol", type: "Objet merveilleux", rarete: "Rare", lien: true, prix: "6 300 po", note: "Basé sur : Vol (+1 niveau, sans concentration, ×4).",
    ...
    { nom: "Protège-poings de puissance à mains nues +1", type: "Objet merveilleux", rarete: "Peu commun", lien: false, prix: "1 320 po", note: "Tour de magie ajouté pour dégâts de force.",
    ...
    { nom: "Protège-poings de puissance à mains nues +2", type: "Objet merveilleux", rarete: "Rare", lien: false, prix: "3 960 po", note: "Tour de magie ajouté pour dégâts de force.",
    ...
    { nom: "Protège-poings de puissance à mains nues +3", type: "Objet merveilleux", rarete: "Très rare", lien: false, prix: "10 890 po", note: "Tour de magie ajouté pour dégâts de force.",
