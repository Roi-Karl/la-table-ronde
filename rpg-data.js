...
Rôle dans le groupe : ligne de front, absorbeur de dégâts, terreur psychologique des ennemis.
            `,
            feminin: `
La Barbare est la guerrière primitive qui puise sa force dans une rage instinctive et sauvage.
Là où d'autres s'entraînent des années pour maîtriser une technique, la Barbare laisse parler
son instinct de prédatrice. En état de Rage, elle dépasse les limites humaines du corps :
elle ignore la douleur, multiplie sa force et se bat jusqu'à la mort sans fléchir.
...
Rôle dans le groupe : ligne de front, absorbeuse de dégâts, terreur psychologique des ennemis.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : donnez-lui un code d'honneur tribal — même le Barbare a des règles.
            `,
            feminin: `
La Barbare est l'arme vivante du groupe. En tant que Maître, elle fonctionne mieux dans
les combats chaotiques à plusieurs ennemis où sa résistance brille. Évitez les longues rencontres
de diplomatie où elle sera frustrée — ou exploitez cette frustration pour créer de la tension dramatique.

Archétypes de voie : Berserker (dégâts purs), Totem (connexion spirituelle animale), Tempête (électricité).
PNJ Barbare typique : cheffe de tribu, garde du corps impulsive, guerrière en quête de la mort honorable.
Défi narratif : l'incontrôlabilité de la Rage peut être une source de complication excellente.
Conseil au Maître : donnez-lui un code d'honneur tribal — même la Barbare a des règles.
            `
        },
        description_physique: {
            masculin: "Le mâle dragonide est massif — écailles dures couvrant tout le corps, museau allongé, queue épaisse servant de contrepoids naturel. Sa stature dépasse souvent les deux mètres. La couleur de ses écailles trahit son héritage draconique — rouge, or, bleu, vert ou blanc. Quand il inspire avant de parler, méfiez-vous.",
...
Rôle dans le groupe : couteau suisse, porte-parole, soutien et amplificateur des alliés.
            `,
            feminin: `
La Barde est une artiste qui a découvert que la magie et l'art sont la même chose.
Sa voix, son instrument ou sa plume canalisent des pouvoirs qui altèrent la réalité.
Elle excelle en soutien, en contrôle et en interaction sociale — et n'est jamais aussi dangereuse
que quand on la sous-estime. Sa magie est universelle : elle peut apprendre des sorts de n'importe quelle classe.
...
Style de jeu : polyvalente, soutien, interaction sociale, contrôle de foule discret.
Armes favorites : rapières, arbalètes de poing, armes de finesse.

Rôle dans le groupe : couteau suisse, porte-parole, soutien et amplificatrice des alliés.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : les Bardes récoltent des histoires — donnez-leur des rumeurs vraies et fausses mêlées.
            `,
            feminin: `
La Barde est le personnage le plus social et narratif du jeu. En tant que Maître, offrez-lui
des situations où la parole est une arme : négociations, infiltrations, interrogatoires.
Sa maîtrise universelle en fait un personnage difficile à coincer — elle aura toujours un outil.

Archétypes de collège : Savoir (sorts bonus, critique amélioré), Vaillance (combat + soutien).
PNJ Barde typique : ménestrel espionne, négociatrice de la cour, manipulatrice politique.
Défi narratif : son charme peut créer des complications romantiques ou des jalousies.
Conseil au Maître : les Bardes récoltent des histoires — donnez-leur des rumeurs vraies et fausses mêlées.
            `
        }
...
Rôle dans le groupe : pilier de survie, soutien moral, expert en créatures surnaturelles.
            `,
            feminin: `
La Clerc n'est pas une simple prêtresse — c'est un conduit vivant de la puissance divine.
Sa foi n'est pas une métaphore : elle se matérialise en sorts de guérison, en boucliers divins
et en jugements foudroyants contre les ennemis de sa déesse. Selon la déité choisie,
la Clerc peut être soignante pacifique, guerrière sacrée, ou nécromancienne au service de la mort naturelle.
...
• Renvoi des morts-vivants — Fait fuir ou détruit les morts-vivants.
• Intervention divine — À haut niveau, appel direct à la déité.
• Domaine divin — Définit l'orientation de la Clerc (Vie, Guerre, Lumière, Mort, Nature, Tempête...).
• Armure divine — Peut porter armures lourdes selon le domaine.

Style de jeu : soutien, guérison, contrôle moral, combat polyvalent.
Armes favorites : masses, fléaux, marteaux de guerre (selon domaine).

Rôle dans le groupe : pilier de survie, soutien moral, experte en créatures surnaturelles.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : définissez les tabous de la déité — certains actes lui coûteront ses pouvoirs.
            `,
            feminin: `
La Clerc est le personnage le plus connecté aux forces cosmiques du monde.
Utilisez sa déité comme fil narratif permanent : l'intervention divine, les signes divins, les missions sacrées.
Son domaine définit son identité plus que sa classe — une Clerc de la Guerre est radicalement différente d'une Clerc de la Vie.

Domaines emblématiques : Vie (guérison maximale), Guerre (DPS divin), Lumière (sorts de feu/radiance), Mort (nécromancie).
PNJ Clerc typique : grande prêtresse corrompue, inquisitrice zélée, guérisseuse de campagne.
Défi narratif : les conflits entre la volonté divine et l'intérêt du groupe sont riches en drame.
Conseil au Maître : définissez les tabous de la déité — certains actes lui coûteront ses pouvoirs.
            `
        }
...
Rôle dans le groupe : adaptateur de terrain, contrôle environnemental, soignant secondaire.
            `,
            feminin: `
La Druide est la gardienne de l'équilibre naturel, héritière d'une tradition plus ancienne que les dieux civilisés.
Sa magie est celle de la terre, de la pluie, du feu et du vent. Sa capacité la plus redoutable
est la Métamorphose : elle peut prendre la forme de n'importe quel animal, adaptant son corps au besoin.
Sa sagesse de la nature lui révèle des vérités que les citadins ne soupçonnent pas.
...
Style de jeu : polyvalente, adaptive, soutien et contrôle.
Armes favorites : bâton, serpe, fronde. Jamais d'armure métallique.

Rôle dans le groupe : adaptatrice de terrain, contrôle environnemental, soignante secondaire.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : les Druides refusent de tuer certains animaux ou plantes — créez des dilemmes autour de ça.
            `,
            feminin: `
La Druide est le personnage le plus connecté au territoire. Ses pouvoirs varient radicalement
selon l'environnement — en forêt, elle est à son apogée ; en ville ou sous terre, elle est bridée.
Jouez sur cette dimension géographique pour la récompenser ou la défier.

Cercles emblématiques : Lune (Métamorphose puissante), Terre (sorts élargis selon terrain), Spores (nécro végétale).
PNJ Druide typique : ermite sage, gardienne territoriale agressive, cheffe d'un culte naturel.
Défi narratif : sa priorité à la nature peut entrer en conflit avec les objectifs "civilisés" du groupe.
Conseil au Maître : les Druides refusent de tuer certains animaux ou plantes — créez des dilemmes autour de ça.
            `
        }
...
Rôle dans le groupe : colonne vertébrale du groupe, damage dealer fiable, protecteur.
            `,
            feminin: `
La Guerrière est la maîtresse des armes et du combat. Là où les autres classes ont des gadgets magiques
ou des pouvoirs spéciaux, la Guerrière a quelque chose de plus fondamental : la maîtrise parfaite
de l'art du combat. Elle frappe plus fort, plus souvent et dans des conditions que les autres ne survivraient pas.
À haut niveau, elle attaque quatre fois par round — aucune autre classe ne l'égale en cadence.
...
Style de jeu : ligne de front, dégâts soutenus, polyvalente selon le style choisi.
Armes favorites : toutes — c'est littéralement sa spécialité.

Rôle dans le groupe : colonne vertébrale du groupe, damage dealer fiable, protectrice.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : donnez-lui un rival militaire de valeur égale — la rivalité de combattants est intemporelle.
            `,
            feminin: `
La Guerrière est la classe la plus fiable et la moins capricieuse du jeu.
En tant que Maître, elle fonctionnera bien dans presque toutes les situations de combat.
Son intérêt narratif vient de son archétype militaire : d'où vient-elle ? Pour qui a-t-elle combattu ?

Archétypes : Championne (critiques élargis), Maîtresse de Bataille (manœuvres tactiques), Chevalière Eldritch (sorts).
PNJ Guerrière typique : capitaine de garde, mercenaire expérimentée, chevalière reconvertie.
Défi narratif : sans pouvoirs magiques, elle peut se sentir dépassée dans des intrigues surnaturelles.
Conseil au Maître : donnez-lui une rivale militaire de valeur égale — la rivalité de combattantes est intemporelle.
            `
        }
    },
...
Rôle dans le groupe : assassin mobile, contrôleur de cibles prioritaires, soutien défensif.
            `,
            feminin: `
La Moine est la classe la plus disciplinée du jeu. Son corps est son arme, son temple et son outil.
À travers des années de méditation et d'entraînement, elle a appris à canaliser le ki —
l'énergie vitale universelle — pour accomplir des exploits qui défient la physique normale.
Elle peut courir sur l'eau, tomber sans se blesser, arrêter des projectiles à mains nues et assommer d'un toucher.
...
Rôle dans le groupe : assassine mobile, contrôleuse de cibles prioritaires, soutien défensif.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : un Moine dont la concentration est brisée (trahison d'un élève, destruction de son monastère) est un personnage transformé.
            `,
            feminin: `
La Moine est l'un des personnages les plus cinématiques du jeu — ses combats ressemblent à de la chorégraphie.
Créez des environnements verticaux et complexes qui valorisent sa mobilité unique.
Attention : son manque de points de vie et son absence d'armure la rendent vulnérable aux dégâts de zone.

Traditions : Poing Ouvert (contrôle pur), Ombre (ninja furtive), Éléments (sorts de ki élémentaires).
PNJ Moine typique : maîtresse d'un monastère, assassine silencieuse, pèlerine en quête spirituelle.
Défi narratif : son rapport au ki et à la discipline entre souvent en conflit avec le chaos de l'aventure.
Conseil au Maître : une Moine dont la concentration est brisée (trahison d'une élève, destruction de son monastère) est un personnage transformé.
            `
        }
    },
...
Rôle dans le groupe : tank-soutien, leader moral, champion des batailles décisives.
            `,
            feminin: `
La Paladin est la classe la plus exigeante moralement — et la plus puissante quand ses convictions tiennent.
Son serment sacré est le fondement de tout son pouvoir : le briser l'affaiblit considérablement.
Ce serment peut être de protection des innocents, de conquête sans merci, de dévouement à une déité,
ou même de vengeance froide. Sa Frappe Divine est l'une des capacités les plus dévastatrices du jeu.
...
Rôle dans le groupe : tank-soutien, leader morale, championne des batailles décisives.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : posez la question centrale — qu'est-ce qui ferait rompre son serment ? Construisez autour.
            `,
            feminin: `
La Paladin est le personnage le plus dramatique du jeu — son serment crée des dilemmes permanents.
Mettez-la face à des situations où respecter son serment coûte quelque chose d'important.
La rupture du serment est un moment narratif de première ordre — gérez-le comme tel.

Serments emblématiques : Dévotion (paladin classique), Vengeance (chasseuse impitoyable), Anciens (nature sacrée), Conquête (tyranne justifiée).
PNJ Paladin typique : chevalière d'un ordre sacré, inquisitrice intransigeante, protectrice d'une relique.
Défi narratif : la rigidité morale crée inévitablement des conflits avec les alliés moins scrupuleux.
Conseil au Maître : posez la question centrale — qu'est-ce qui ferait rompre son serment ? Construisez autour.
            `
        }
...
Rôle dans le groupe : éclaireur, chasseur de cibles prioritaires, expert de survie.
            `,
            feminin: `
La Rôdeuse est la maîtresse de la survie et de la chasse dans les territoires sauvages.
Sa connaissance du terrain, sa précision au tir et son lien spirituel avec la faune en font
une éclaireuse et une chasseuse de prime incomparable. Elle choisit un ennemi favori et un terrain favori —
dans son environnement idéal, face à sa proie préférée, elle n'a pas d'égale.
Ses compagnons animaux combattent à ses côtés avec une fidélité absolue.
...
• Explorateur naturel — Déplacement et survie optimaux dans un type de terrain.
• Style de combat — Archerie (bonus +2 aux tirs), Défense, Duel, Combat à deux armes.
• Compagnon animal — Un animal lié combat et explore aux côtés de la Rôdeuse.
• Attaque multiple — 2 attaques par round dès le niveau 5.

Style de jeu : harcèlement à distance, mobilité, connaissance du terrain, dégâts précis.
Armes favorites : arc long, deux lames courtes, arbalète.

Rôle dans le groupe : éclaireuse, chasseuse de cibles prioritaires, experte de survie.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : le compagnon animal est son talon d'Achille émotionnel — utilisez-le avec précaution.
            `,
            feminin: `
La Rôdeuse excelle hors des donjons et des villes — créez des rencontres en pleine nature pour qu'elle brille.
En milieu urbain, elle perd une grande partie de ses avantages : exploitez cette vulnérabilité dramatiquement.

Archétypes : Chasseuse (dégâts purs), Maîtresse des Bêtes (compagnon animal renforcé), Guetteuse (magie de terrain).
PNJ Rôdeuse typique : chasseuse de primes solitaire, guide de frontière, éclaireuse militaire d'élite.
Défi narratif : son lien avec un ennemi juré peut créer des conflits si le groupe doit s'allier à cet ennemi.
Conseil au Maître : le compagnon animal est son talon d'Achille émotionnel — utilisez-le avec précaution.
            `
        }
...
Rôle dans le groupe : expert des situations spéciales, assassin de cibles uniques, espion.
            `,
            feminin: `
La Roublarde est la maîtresse de l'opportunisme et de la précision. Elle ne frappe pas souvent — elle frappe juste.
Son Attaque sournoise lui permet d'infliger des dégâts massifs sur une cible qui ne s'y attend pas.
Sa polyvalence en compétences en fait le personnage le plus apte à gérer les situations hors-combat :
serrures, pièges, infiltration, déguisement, escroquerie. Un groupe sans Roublarde manque souvent d'outils.
...
Rôle dans le groupe : experte des situations spéciales, assassine de cibles uniques, espionne.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : donnez-lui des accès cachés, des passages secrets — laissez-le briller dans la préparation.
            `,
            feminin: `
La Roublarde est le couteau suisse non-magique du groupe. Créez des rencontres qui valorisent
ses compétences hors-combat : infiltration, tromperie, désarmement de pièges complexes.
Sa furtivité peut complètement transformer la dynamique d'un donjon.

Archétypes : Assassine (burst d'initiative), Escroc arcanique (sorts de Mage), Érudite (compétences intellectuelles).
PNJ Roublarde typique : maîtresse voleuse, espionne de la couronne, informatrice de guilde.
Défi narratif : sa méfiance naturelle peut compliquer la construction de confiance dans le groupe.
Conseil au Maître : donnez-lui des accès cachés, des passages secrets — laissez-la briller dans la préparation.
            `
        }
    },
...
Rôle dans le groupe : lance-sort polyvalent, spécialiste du burst magique, adaptateur de style.
            `,
            feminin: `
L'Ensorceleure ne choisit pas la magie — elle est née avec elle. Un ancêtre dragon, un événement
cosmique, une bénédiction ou une malédiction divine : sa magie est inscrite dans ses cellules,
dans son souffle, dans ses émotions. Quand elle est en colère, les objets bougent.
Quand elle est terrifiée, des flammes jaillissent. Cette magie impulsive et innée est sa force et son risque.
Sa ressource principale, les Points de Sorcellerie, lui permet de remodeler ses sorts en temps réel.

Différence fondamentale avec le Magicien et le Sorcier :
• L'Ensorceleure RESSENT la magie — elle coule en elle comme le sang.
• Elle n'a pas besoin d'étudier ni de pactiser — c'est son ADN.
• Moins de sorts connus, mais une flexibilité de casting unique.
...
Rôle dans le groupe : lance-sort polyvalente, spécialiste du burst magique, adaptatrice de style.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : demandez un jet de Magie Sauvage dans les moments de stress émotionnel intense — pas seulement au combat.
            `,
            feminin: `
L'Ensorceleure est la mage la plus instable et la plus dramatique. La Magie Sauvage peut déclencher
des effets aléatoires à chaque sort — source de chaos et d'humour garantie.
Son lien émotionnel à la magie crée des scènes riches : la peur qui déclenche une explosion involontaire.

Origines : Héritage Dragon (stabilité, dégâts), Magie Sauvage (chaos, tables aléatoires), Tempête (contrôle météo).
PNJ Ensorceleure typique : noble à la magie instable, enfant prodige incontrôlable, héritière d'une malédiction draconique.
Défi narratif : son manque de contrôle peut mettre le groupe en danger involontairement.
Conseil au Maître : demandez un jet de Magie Sauvage dans les moments de stress émotionnel intense — pas seulement au combat.
            `
        }
...
Rôle dans le groupe : damage dealer magique polyvalent, utilitaire hors-combat, négociateur mystique.
            `,
            feminin: `
La Sorcière n'est pas née avec la magie et ne l'a pas étudiée. Elle l'a négociée.
Quelque part dans son passé, elle a conclu un pacte avec une Entité — un Grand Ancien,
un Fiélon, une Fée archétypale — et en a reçu des pouvoirs en échange d'un service indéterminé.
Cette relation de pouvoir déséquilibrée est le cœur de sa psychologie : elle est puissante, mais redevable.
Sa magie est ciblée, efficace et récupère rapidement (sur repos court, pas long).

Différence fondamentale avec l'Ensorceleure et la Magicienne :
• La Sorcière NÉGOCIE la magie — elle lui est accordée par une entité.
• Peu de sorts, mais toujours au niveau maximum disponible.
• Elle est la seule dont la magie a une personnalité propre (celle de l'Entité).
• Son Eldritch Blast est sa signature — une attaque magique infinie et personnalisable.
...
Rôle dans le groupe : damage dealer magique polyvalente, utilitaire hors-combat, négociatrice mystique.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : l'Entité n'explique jamais tout — cultivez le mystère de ce qu'elle veut réellement.
            `,
            feminin: `
La Sorcière est le personnage avec le lien NPC le plus intégré mécaniquement — son Entité.
Utilisez cette Entité comme fil narratif permanent : elle a des objectifs, elle communique (ou pas),
elle exige des actes. C'est une source de quêtes, de conflits et de révélations inépuisable.

Entités emblématiques : Grand Ancien (horreur cosmique), Fiélon (diable ou démon), Archefée (fée puissante et capricieuse).
PNJ Sorcière typique : politicienne qui a vendu son âme, mystique en dette avec une entité, héroïne corrompue progressivement.
Défi narratif : l'Entité peut contacter la Sorcière au pire moment et exiger quelque chose d'impossible.
Conseil au Maître : l'Entité n'explique jamais tout — cultivez le mystère de ce qu'elle veut réellement.
            `
        }
    },
...
Rôle dans le groupe : artilleur magique, solutionneur de problèmes complexes, expert théorique.
            `,
            feminin: `
La Magicienne est la mage la plus puissante au niveau maximum — et la plus fragile au combat.
Sa magie est pure connaissance : elle a passé des années à étudier des grimoires, à mémoriser
des formules complexes et à comprendre les lois fondamentales de l'Arcane.
Elle ne ressent pas la magie (contrairement à l'Ensorceleure) ni ne la négocie (contrairement à la Sorcière) —
elle la COMPREND. Et cette compréhension lui donne accès à la liste de sorts la plus large du jeu.

Différence fondamentale avec l'Ensorceleure et la Sorcière :
• La Magicienne MÉMORISE la magie — chaque sort est une équation gravée dans son esprit.
• Sa liste de sorts est illimitée en théorie (elle peut copier tout sort trouvé).
• Elle est la seule à pouvoir apprendre des sorts d'école exclusive.
• Fragile physiquement — ne touchez pas la Magicienne.
...
Rôle dans le groupe : artilleuse magique, solutionneuse de problèmes complexes, experte théorique.
            `
        },
        description_maitre: {
            masculin: `
...
Conseil au Maître : donnez-lui des ennemis qui résistent à la magie ou l'annulent — c'est là qu'il doit improviser.
            `,
            feminin: `
La Magicienne est la classe qui récompense le plus la préparation — la sienne ET la vôtre.
Elle connaît potentiellement la solution magique à chaque problème. Créez des situations où
aucun sort simple ne suffit, où il faut combiner les connaissances de manière créative.

Écoles emblématiques : Évocation (dégâts purs), Illusion (tromperie totale), Divination (connaissance future), Nécromancie (morts-vivants).
PNJ Magicienne typique : archimage arrogante, professeure d'académie, bibliothécaire secrète de sorts interdits.
Défi narratif : sa fragilité physique la rend dépendante des alliés — jouez sur cette vulnérabilité.
Conseil au Maître : donnez-lui des ennemis qui résistent à la magie ou l'annulent — c'est là qu'elle doit improviser.
            `
        }
    }
};
...
const RPG_GRADES = [

    {
        ...
        coul: "#7f8c8d",
        tooltip: {
            masculin: "Un inconnu qui a poussé la porte du royaume pour la première fois.",
            feminin:  "Une inconnue qui a poussé la porte du royaume pour la première fois."
        },
...
La Serve Égarée n'a pas encore de place à la Table, mais la porte lui est ouverte. Chaque jour passé dans le royaume forge un peu plus sa réputation. On ne devient pas chevalière en un soir — mais tout commence ici, dans cette première hésitation sur le seuil.
...
Conseil : envoyez un message de bienvenue personnalisé dès ce rang pour ancrer l'engagement.
...

    {
        ...
        coul: "#95a5a6",
        tooltip: {
            masculin: "Le paysan qui ose lever les yeux vers l'horizon.",
            feminin:  "La paysanne qui ose lever les yeux vers l'horizon."
        },
...
La Vileine Courageuse est la première marche d'un long escalier. Elle travaille dur, apprend vite et regarde les chevalières avec des étoiles dans les yeux — et un peu d'envie dans le cœur. Ce n'est pas de l'arrogance : c'est de l'ambition légitime.

La terre qu'elle laboure n'est pas la sienne encore. Mais un jour, peut-être, elle aura son propre fief.
...
Conseil : proposez-lui une première action simple (remplir son profil, commenter une vidéo) pour créer un premier geste d'engagement.
...

    {
        ...
        coul: "#bc8f8f",
        tooltip: {
            masculin: "Apprenti prometteur qui porte l'écu avec fierté.",
            feminin:  "Apprentie prometteuse qui porte l'écu avec fierté."
        },
...
Prochain rang dans : 10 jours de présence.
            `,
            feminin: `
Cinq jours et vous avez déjà la posture d'une combattante. L'Écuyère Novice a pris les armes — symboliquement — et s'entraîne chaque jour à mériter sa place.

Elle suit les chevalières, apprend leurs gestes, écoute leurs récits de bataille. Le métal de son bouclier est encore brillant car il n'a pas encore servi — mais cela ne saurait tarder. Sa maîtresse d'armes l'observe. La prochaine épreuve révélera ce qu'elle vaut vraiment.

Chaque nuit, elle repasse mentalement ce qu'elle a appris. Chaque matin, elle revient plus déterminée.
...
Conseil : encouragez la complétion du profil (race, classe, alignement) à ce stade — cela renforce l'identité dans le royaume.
...

    {
        ...
        coul: "#cd7f32",
        tooltip: {
            masculin: "Homme de fief lié par serment à la Table.",
            feminin:  "Femme de fief liée par serment à la Table."
        },
...
Prochain rang dans : 20 jours de présence.
            `,
            feminin: `
Dix jours. Vous avez prêté serment — tacitement — en restant. La Vassale du Fief a choisi son camp : celui de la Table Ronde (mais carrée).

Elle possède désormais une terre symbolique dans le royaume et une voix dans les affaires courantes. Les chevalières la reconnaissent. Son nom commence à circuler dans les couloirs du château. On ne l'appelle plus "la nouvelle" — on l'appelle par son nom.

Un serment de vassale n'est pas rien dans un royaume médiéval. C'est une promesse de fidélité. Et la fidélité, ici, est la monnaie la plus précieuse.
...
Conseil : reconnaître publiquement ce palier (dans une vidéo ou annonce) renforce l'attachement communautaire.
...

    {
        ...
        coul: "#bdc3c7",
        tooltip: {
            masculin: "Chevalier libre qui sillonne le royaume en quête de gloire.",
            feminin:  "Chevalière libre qui sillonne le royaume en quête de gloire."
        },
...
Prochain rang dans : 40 jours de présence.
            `,
            feminin: `
Vingt jours, et vous avez franchi le seuil de la chevalerie. L'épée est à votre ceinture, la monture sous vos pieds. La Chevalière Errante n'est attachée à aucune cause fixe — elle cherche encore sa voie — mais son courage est reconnu de tous.

On dit que les meilleures chevalières du Roi Karl ont toutes commencé comme ça : sans destination, mais avec une volonté de fer. Les routes du royaume sont longues. Les défis sont nombreux. Et chaque victoire, petite ou grande, grave votre nom un peu plus profondément dans les chroniques.
...
Conseil : proposez-lui des défis communautaires (partage de contenu, création, tournois) pour canaliser son engagement croissant.
...

    {
        ...
        coul: "#f1c40f",
        tooltip: {
            masculin: "Voix officielle du royaume, porteur des annonces du Roi.",
            feminin:  "Voix officielle du royaume, porteuse des annonces du Roi."
        },
...
Prochain rang dans : 70 jours de présence.
            `,
            feminin: `
Quarante jours de fidélité — vous avez mérité la trompette dorée. La Héraute Royale est la voix du royaume. C'est elle qu'on entend annoncer les grandes nouvelles, les tournois, les décrets du Roi Karl.

Son prestige lui vient non pas de la force de son épée, mais de la force de sa parole. Dans une cour, une voix qui porte est parfois plus puissante qu'une armée. La Héraute sait ça. Elle choisit ses mots avec soin, elle les lance avec conviction, elle les fait résonner dans les salles de pierre.

Quand la Héraute parle, le royaume écoute.
...
Conseil : identifiez les Hérauts Royaux pour en faire des modérateurs informels ou des "parrains" de nouveaux membres.
...

    {
        ...
        coul: "#e67e22",
        tooltip: {
            masculin: "Noble de la Table, hôte des grands festins royaux.",
            feminin:  "Noble de la Table, hôtesse des grands festins royaux."
        },
...
Prochain rang dans : 120 jours de présence.
            `,
            feminin: `
Soixante-dix jours. Vous êtes maintenant une noble à part entière — la Baronne de la Carrée. La Table (ronde mais carrée, rappelons-le) a une place réservée à votre nom.

Les festins royaux ne sont pas complets sans vous. Votre opinion pèse dans les conseils. Le Roi Karl vous consulte — pas toujours, mais parfois — et c'est déjà un honneur immense. Votre château est petit mais solide. Votre bannière flotte fièrement.

Une baronne sait recevoir, négocier, et — quand il le faut — trancher. Vous avez appris tout ça en soixante-dix jours de présence active.
...
Conseil : consultez les Barons lors de décisions importantes pour la communauté. Leur sentiment de co-construction renforce leur fidélité à long terme.
...

    {
        ...
        coul: "#8b0000",
        tooltip: {
            masculin: "Guerrier d'élite, formateur des futures générations.",
            feminin:  "Guerrière d'élite, formatrice des futures générations."
        },
...
Prochain rang dans : 200 jours de présence.
            `,
            feminin: `
Cent vingt jours de présence forgent une Maîtresse d'Armes. Vous n'apprenez plus : vous enseignez. Les jeunes serves et vilaines vous regardent avec admiration. Vos gestes sont précis, votre jugement sûr, votre loyauté éprouvée.

La Maîtresse d'Armes est le pilier militaire du royaume. Quand la Table a besoin d'un bras armé, c'est vers vous qu'on se tourne en premier. Vous avez vu passer assez de chevalières pour savoir lesquelles ont l'étoffe des grandes — et lesquelles prétendent seulement.
...
Conseil : offrez aux Maîtres d'Armes des responsabilités concrètes (organisation d'événements, curation de contenu) pour maintenir leur engagement sur la durée.
...

    {
        ...
        coul: "#4a0404",
        tooltip: {
            masculin: "Grand commandant des armées, second du Roi.",
            feminin:  "Grande commandante des armées, seconde du Roi."
        },
...
Prochain rang dans : 365 jours de présence.
            `,
            feminin: `
Deux cents jours de fidélité absolue. La Haute Connétable est la commandante suprême des armées du Roi Karl. Au-dessus d'elle, il n'y a qu'une seule personne.
...
Conseil : contact direct avec le Roi Karl, accès à des coulisses exclusives, co-création de contenu. Ces membres méritent un traitement exceptionnel.
...

    {
        ...
        coul: "#d4af37",
        tooltip: {
            masculin: "Le bras droit du Roi, gardien du royaume en son absence.",
            feminin:  "Le bras droit du Roi, gardienne du royaume en son absence."
        },
